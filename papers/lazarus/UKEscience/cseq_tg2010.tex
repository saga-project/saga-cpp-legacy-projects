...
machine, e.g., RQA-BQP, %represents the scenario where
...
RQA-BQP (table~\ref{table:AllBQP}) when all three resources are utilized in the solution of the problem.
...
of the rocks, figure~\ref{fig:permpor} top) and porosity (a measure of the capacity of the rocks, figure~\ref{fig:permpor} bottom) is 
...
\caption[Simulation Output]{[Top] Reservoir as characterised by the
  permeability, and [Bottom] porosity. }
\label{fig:permpor}
\end{figure}
