...
\jhanote{Bad sentence..} Developed, initially using Cactus and
...
MySQL in Lazarus. \jhanote{Same mistakes.. terms/concepts are used
that mean nothing to others and we don't bother definining
them. e.g. advert service.}
