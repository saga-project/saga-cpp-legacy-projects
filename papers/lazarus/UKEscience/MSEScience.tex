...
technologies and abstractions that allow performing large scale reservoir characterization
and CO$_2$ sequestration studies. This infrastructure enables the seamless use distributed, heterogeneous
...
formations responsible for the existence of oil and gas reservoirs. Indeed much of the 
technology behind carbon dioxide sequestration 
(including drilling, gas injection, reservoir management and reservoir 
...
oil and gas for production, thus reducing the net cost through increased revenues 
...
latest sensor data will hopefully enable predicting un-intended movement of CO$_2$, 
