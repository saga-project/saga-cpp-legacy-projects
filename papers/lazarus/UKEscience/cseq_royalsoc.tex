...
application developers perspective.  It is important to understand
that there is a distinct advantage of going distributed \fixme{...}.
It is also useful to note that for the end-user, the complexity of
using one resource is the same as using multiple resources; however,
the gains increase with every added resource.
