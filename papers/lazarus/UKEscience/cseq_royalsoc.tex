...
\begin{figure}
\begin{center}
\includegraphics[scale=0.275]{./figures/SensorRelay.png}
\end{center}
\caption[Sensors to Simulations data flow]{Real-time transfer of field sensor data to the EnKF application is a two stage process: streaming from sensor platforms to database and queries from the EnKF. \jhanote{this figure needs attention}}
...
\section{Addressing EnKF Scalability: Scaling-up and Scaling-out}
