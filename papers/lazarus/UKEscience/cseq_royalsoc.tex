...
For our purposes we make the same simplifying assumptions about the injected CO$_2$, as in ~\ref{Pawar}. Carbon
...
In contrast, Houtekamer and Mitchell ~\ref{Hout98} found that while
...
~\ref{Mitchell02}. However, if a small ensemble size requiring severe
