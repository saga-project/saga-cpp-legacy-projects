...
\author[el-khamra, jha, white]{Yaakoub el-Khamra$^{1}$,Shantenu Jha$^{2,3,4*}$, Christopher D. White$^{2,5}$ \\
...
\begin{figure}[!ht]
\begin{center}
     \includegraphics[scale=0.4]{stci-saga-figures-1.pdf}
\end{center}
...
\begin{figure}
\begin{center}
 \includegraphics*[scale=0.3,angle=0]{figures/DetailedSensorFlow.png}
\end{center}
