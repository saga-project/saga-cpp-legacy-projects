...
\begin{table}
	...
	\begin{tabular}{|p{5cm}|l|}
          ...
          Number of MPI processes for a single NAMD run &16\\ \hline 
...
the coupled distributed run, 1/4 of the processes were allocated to
the smaller machine (Poseidon), while the bulk stayed on QB.  As the
