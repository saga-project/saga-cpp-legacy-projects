...
replicas, could be one obstacle for routine usages.  This paper aims
to demonstrate the efficient implementation armed with grid-enabled
SAGA framework as well as fault-recovery SAGA CPR Migol
infrastructurure.  Our development comprises three components.  The
