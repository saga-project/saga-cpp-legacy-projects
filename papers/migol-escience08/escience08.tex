...
correct programmatic and system abstractions: enable users to do
what they do best, % and must do
...
docking simulations used e.\,g.\ for the evaluation of drugs. While
this application has a similar high throughput characteristic, the
...
Grids via appropriate adaptors, as SAGA is a community specification
