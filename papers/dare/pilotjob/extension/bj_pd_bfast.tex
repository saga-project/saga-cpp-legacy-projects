...
5 PJ interop using the TROY API
...
\section{A Conceptual Framework for Pilot-Abstractions for Dynamic Execution}
...
\section{TROY: A SAGA-based Implementation of the Pilot-Abstraction for Dynamic Execution}
...
BigJob is the SAGA-based TROY implementation. It supports a wide range of 
application types, and is usable over a broad range
of infrastructures, i.\,e.\ it is general-purpose and extensible.
To aid the understanding of the framework we define two kind of BigJobs, the 
atomic and the dynamic BigJob:
\begin{itemize}
...
\section{Propose new section here for all non-SAGA implementations of PJ}
\subsection{Diane}
