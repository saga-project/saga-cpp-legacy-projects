...
\begin{enumerate}[A.]
	...
	that may be dynamically added to it. The PJ (also referred to as pilot) is the entity that actually gets 
	...
	\item \textbf{Unit of Work (UW):} A unit of work is a workload that is 
	independent form a resource. A unit of work can be assigned to a 
	sub-job/job.(This is essentially a task, but we did not use that term because of its usage in the SAGA context)
	\item \textbf{Unit of Scheduleable Entity (US):} schedule-able entities are 
