...
here binding occurs before job submission?} \alnote{I think not: affinity are just a constraint that is put on a subjob. However, there can be e.g. multiple bigjob in a manyjob that satisfy a constraint} &yes &Push &SAGA Advert service &no\\
	\hline
\end{tabular}
