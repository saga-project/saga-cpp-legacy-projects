...
\newcommand{\smnote}[1]{ {\textcolor{green} { ***athota: #1 }}}
\else
\newcommand{\alnote}[1]{}
...
\begin{tabular}{|l|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|}
	...
	\hline
	\hspace{4mm} Cloud adaptor (EC2) &At sub-job submission  &n \alnote{Are you sure? Without ManyJob this should be difficult to do?} &Push/Pull &SAGA Advert service  &no\\ 
	\hline
 	BigJob-Cloud &At sub-job submission &n &Push&Local Python Queue &no\\ 
	\hline
	BigJob-Azure &while BigJob Agent searching for the new subjobs \alnote{What do you mean with that?} 
	             &n &Push/Pull &Azure Storage &no\\ 
	\hline
    BigJob-Diane &late &n &Pull &yes &CORBA\\ 
	\hline
    ManyJob &At sub-job submission &n &Push/Pull &SAGA Advert service&no\\
	\hline
