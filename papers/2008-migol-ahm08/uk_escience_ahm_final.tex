...
\begin{figure}[t]
            \centering
                \includegraphics[width=\textwidth]{migol_architecture}
...
Checkpointing and rollback recovery is widely used in Grids. 
...
Further, these frameworks do not address the fault tolerance of the infrastructure services.
