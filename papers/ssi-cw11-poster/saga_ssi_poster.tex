...
\definecolor{HeadColor}{rgb}{0.3,0.3,0.3}
...
\begin{textblock}{3.8}(0,0)
  \includegraphics[width=300mm]{saga}
\end{textblock}

\begin{textblock}{3.8}(11.29,-0.1)
  \includegraphics[width=195mm]{saga_url}
\end{textblock}
...
\large~(Center for Computation \& Technology, Louisiana State University)
}
\end{textblock}
...
\begin{list}{\labelitemi}{\leftmargin=1.6em}
...
% SAGA allows the project to
% explore advanced pipelining and workflow strategies for ncRNA research
% on grids and clouds without being locked-in to a specific
% infrastructure provider or technology.
