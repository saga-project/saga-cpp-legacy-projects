...
We will evaluate the multi-species polyatomic Lagrangian dynamics modeling by analyzing two different fluid models: the mixture of two monatomic fluids and a polyatomic molecular fluid under the short-range potential.
...
the long-range interaction (i.e., Coulomb force) is not considered. We will 
...
monatomic molecule species differing in mass. Chemical properties of
...
the Lagrangian dynamics modeling for polyatomic molecules.
