...
\usepackage{epstopdf}
\usepackage{color}
\usepackage[left=1.0in,top=0.5in,right=1.0in,bottom=1.8in]{geometry}
...
%\jhanote{Please change the ``SAGA Glide-In Manager'' to ``SAGA BigJob Manager''}
\end{figure}
...
%\jhanote{We have limit of 3 pages == 2 for text, 1 for figures. Please observer these constraints and adjust the size of these figures accordingly}}
\end{figure}
