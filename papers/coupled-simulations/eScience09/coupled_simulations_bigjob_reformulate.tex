...
Difficulty of starting multiple applications concurrently; (ii) Inability
...
Three different scenarios arise here. In the first scenario, a single BigJob is
...
bigger BigJob. Variant of the above, when the two BigJobs are on
