...
until the simulation completes. Runtime reduces from 153 seconds at
the initial stage to 107 seconds after the convergence. Total
...
implies that the BigJob application manager spends about 13 seconds on
executing its internal commands including the run of a load balancing
function and sub-job re-launch. \jhanote{I don't see how this is
  13seconds saving? I can't see what the numbers 596 and 663s
  represent??}
