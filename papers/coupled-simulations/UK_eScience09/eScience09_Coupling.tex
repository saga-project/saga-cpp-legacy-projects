...
\usepackage{epstopdf}
\usepackage{color}
\usepackage[left=1.0in,top=0.0in,right=1.0in,bottom=2.6 in]{geometry}
...
\fancyhead[L]{}
\fancyhead[R]{}
\cfoot{Efficient Management of Coupled Multi-Physics Simulations Using SAGA-based Abstractions~\thepage~of \pageref{LastPage}}
