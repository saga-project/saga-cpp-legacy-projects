...
A hybrid CFD-MD framework is employed to solve the multi-physics flow in nano-scale. The experiment problems are the sudden-start Couette flow and the oscillating boundary problem. We start by determining the coupling parameters, validate and verify the hybrid simulation framework, and then proceed to the exploration of the moderate-speed flow simulation and the time-accurate hybrid simulation.
