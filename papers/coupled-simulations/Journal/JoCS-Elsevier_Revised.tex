...
%the noise-free hybrid solution under the non-artificial velocity condition.
...
%The transient Couette flow simulation in O(10) m/s velocity field
%is the first successful report of a moderate-speed flow simulation
