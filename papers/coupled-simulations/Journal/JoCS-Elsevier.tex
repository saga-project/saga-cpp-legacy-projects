...
The result of computation time evolution in 512 px (=32 nodes) case is presented 
in Fig.~\ref{Fig:LBLarge}. Compared to the above experiment when smaller px are used, 
