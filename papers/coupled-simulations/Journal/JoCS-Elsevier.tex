...
a significant reduction in the runtime compared to 
successful conventional jobs when 256 processors are used -- 23.5\%. 
For larger problem set, the performance gain through the application of
a LB is relatively small (6.1\%), which is more or less related to 
the scalability of application codes.
