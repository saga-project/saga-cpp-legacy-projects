...
\footnotesize
\begin{tabular}
{p{0.15\linewidth} || p{0.1\linewidth} p{0.1\linewidth} p{0.1\linewidth} p{0.1\linewidth} p{0.1\linewidth}}
%{>{\centering}p{0.15\linewidth} || p{0.3\linewidth} | p{0.3\linewidth} }
