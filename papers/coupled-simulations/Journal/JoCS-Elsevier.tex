...
\hline
\hline
\multirow{4}{0.1\linewidth}{256} & \multirow{2}{0.1\linewidth}{6 Hrs} & S0 & 20237.9 + 1045.3\\
\cline{3-4}
&  & S1 & 19720.3\\
\cline{2-4}
& \multirow{2}{0.1\linewidth}{24 Hrs} & S0 & 5035.8 + 9933.3\\
\cline{3-4}
&  & S1 & 16165.0\\
\hline
 \multirow{4}{0.1\linewidth}{512}& \multirow{2}{0.1\linewidth}{6 Hrs} & S0 & 15515.7 + 446.1\\
\cline{3-4}
&  & S1 & 15825.4\\
\cline{2-4}
& \multirow{2}{0.1\linewidth}{24 Hrs} & S0 & 4182.6 + 11096.3\\
\cline{3-4}
&  & S1 & 13627.9\\
\hline
\end{tabular} %}
...
In a hybrid CFD-MD simulation, load balancing between CFD and MD 
is not highly required since MD usually requires far more computing power 
than CFD. Additionally, computational cost for the current application in
Sec.~\ref{sec:accuracy_conditions} is so small that it is very hard to 
obtain the reliable data which can quantify the performance gain by a LB.
%verify the performance gain through the use of LB.
This leads us to increase computational domain size
of each simulation, for the purpose of evaluating the load balancing 
capability in a BigJob framework. In this experiment, CFD domain size
is increased by 500 times and MD domain is increased by 20 times.
