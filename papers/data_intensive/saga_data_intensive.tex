...
\begin{enumerate}
\item When both \sagamapreduce workers
  (compute) and data-distribution is local. Number of workers vary
...
%   and Hadoop)
\item \sagamapreduce when workers are locally computed, but using a distributed FS (HDFS)
