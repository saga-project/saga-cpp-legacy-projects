...
\author{Chris Miceli$^{12}$, Michael Miceli$^{12}$, Shantenu
...
% Funding for SAGA specification and development has been
% provided by the 
...
SAGA team.  We also acknowledge internal resources of the Center for
Computation \& Technology (CCT) at LSU and computer resources provided
by LONI. Michael Miceli was supported by a Google Summer of Code
grant.  \bibliographystyle{plain} \bibliography{saga_data_intensive}
\end{document}
