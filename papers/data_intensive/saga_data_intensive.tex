...
Observation: the efficiency is pretty close to 1. Like all good (data)
parallel applications. \tc for 1GB = 659, \tc for 10GB = 6286s.
This is true even when the compute is distributed over two machines:\\
(1 worker each): $T_c = $ 672s, $T_c = $ 1081s, $T_c = $ 2051s for
