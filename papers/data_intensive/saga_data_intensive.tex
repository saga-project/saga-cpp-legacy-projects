...
5) %Figures~\ref{grids1}, \ref{grids2}, \ref{grids3}
...
%   \hline \hline
  ...
  local \& KFS & 2 & 0.2 & 454 \\
  \hline \hline
  local \& LFS&  4 & 0.5 & 1083s\\
  \hline
   local \& KFS &  4 &  0.5&  912s \\
\hline \hline
\end{tabular}
...
\begin{figure}[t]
      \centering
          ...
          \caption{\tc for \sagamapreduce using one worker (local to
            ...
            caching and other advanced features in HDFS which prove
            to be useful, even though it is not being used in a
            distributed fashion. Case III
            corresponds %to \sagamapreduce
