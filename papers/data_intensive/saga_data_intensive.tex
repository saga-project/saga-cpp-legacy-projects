...
Any {\it valid} abstraction will provide most, if not all of the above
features I a nutshell, primary aim of this work is to establish that
SAGA is a {\it valid} abstraction that can support different
