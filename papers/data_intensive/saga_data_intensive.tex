...
%\begin{compactitem}
\begin{enumerate}
\item \sagamapreduce:  versus native MapReduce (using HBase and Hadoop)
\item \sagamapreduce: local versus distributed file system (HDFS) using 
 upto 3 workers (upto a data-set size of 10GB).
\item \sagamapreduce: Vary the number of workers and the size of
  the data-set for local-file systems
\item \sagamapreduce: distributed file system using KFS upto 10
  workers (using data-set sizes upto 10GB)
\end{enumerate}
%\end{compactitem}
