...
unable to utilise our entire distributed system, using at most 4 jobs per machine to
handle our work.
...
experiments that utilised CloudStore to access and store data outperformed
...
DFS are already well renowned for, also has added
...
copied to previously when assigning work; the DFS 
