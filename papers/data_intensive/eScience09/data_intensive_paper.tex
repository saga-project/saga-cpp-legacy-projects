...
and simply implemented the comparison function. The comparison function
...
relatively small output $O$(KB), the genome comparison application can
...
For the experimens, to utilise both CloudStore and GridFTP within one
...
influence experimental results. The experiments can be
...
In figure \ref{Fig:ExpIConventionalLocal}, we show the results for
...
performance. The lowest times of the heuristic approach were about the
...
\caption{(287MB). [Left] The figure
 ...
 eight workers, while the heuristic approach improved its performance
