...
\caption{\textit{Comparison of CloudStore using the All-Pairs
    application for different number of machines.} \jhanote{This caption needs attention}}
...
\caption{\textit{Figure shows that the Tc for upto 3 resources. Shows
    the sclaeout performance can be good...}}
\label{}
\end{figure}
\end{center}
