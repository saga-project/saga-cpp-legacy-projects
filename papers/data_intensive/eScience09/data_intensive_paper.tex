...
value.; $f\!s$ is the type of filesystem used; $m$ is the method used to
...
number of workers $N_w$, and indirectly the granularity of work. By
...
\caption{Performance results for All-Pairs using gridFTP for
