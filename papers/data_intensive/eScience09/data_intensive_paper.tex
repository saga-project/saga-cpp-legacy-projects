...
linearly \betynote{how did you come up with this conclusion?}.  The
second experiment is naive in the way that it attempts to optimise
...
specific group of files~\cite{filecule}. Attempting to determine if
