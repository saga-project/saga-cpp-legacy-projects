...
system-level tools and applications of each of these types. In~\cite{saga_montage_escience09} we discussed how SAGA was used to
implement a higher-level API to support workflows. In~\cite{saga_ccgrid09} we discussed how MapReduce could be
developed.
...
source DFS CloudStore (formerly KFS), which is
...
of experiments in order to compare DFS with manual
file management. There are many questions we try to answer. For
example, is a DFS slower than manual
placement of data? When manually handling data, what are the advantages
of being able to move work to data to the work? For this, we define
the time to completion $t_c$ as:
 \begin{equation}
