...
% GridFTP is provided by the Globus Toolkit, an open source software
% toolkit released under the Apache License version 2.0. Globus
% provides tools used to create and manage grid infrastructures.
...
application.  Each matrix element describes the similarity between
 the corresponding sets. (Larger values indicate more similarity.)} \label{Fig:SAGA1}
\end{figure}
