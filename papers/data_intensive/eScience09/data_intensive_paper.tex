...
assignments generated.each set; \betynote{most of the graphs don't
  talk about $N_c$, either we say that before hand, and erase $N_c$ in
  here, or we add $N_c$ to all graphs, most of the cases $N_c= 8$}
$M_c$ is a comma separated list, of the machine configurations, of the
...
\begin{center}
\begin{figure}
\subfigure{\includegraphics[scale=0.5]
...
\subfigure{\includegraphics[scale=0.5] {data/graphs/CloudStore3Mach}
