...
An aim of this paper is to present a credible initial benchmarking
...
\subfigure[$(c_s, N_c, f\!s, m)=(\mbox{287MB, 8, local, gridFTP})$]{
...
placement heuristics versus distributed file systems -- for executing
distributed data-intensive applications. It should be noted that our
utilising SAGA to access CloudStore-based and gridFTP-based files,
introducing a small but negligible overhead.
