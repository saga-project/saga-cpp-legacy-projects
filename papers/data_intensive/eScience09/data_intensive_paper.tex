...
required. We develop and study an All-Pairs based genome sequence
matching application as a representative data-intensive
application. This paper aims to understand the factors that influence
the performance of this application and their interplay. We also
demonstrate how the SAGA approach can enable data-intensive
...
strategies versus distributed file systems -- for executing
...
meet a range of design \& performance metrics on the other. New
...
greatly between different infrastructures, hence it is difficult to
estimate {\it a priori} the application-level performance on a given
DFS. Thus having the ability to compare and contrast different DFS for
...
All-Pairs based application (Section 3). Section 4 offers an
...
results. In Section 5 we review the
understanding gained and look ahead.
