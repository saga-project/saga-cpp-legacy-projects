...
\usepackage{times} \usepackage{multirow} \usepackage{listings}
\usepackage{times} \usepackage{paralist} \usepackage{epsfig}
\usepackage{subfigure} \usepackage[hypertex]{hyperref}
\usepackage{subfigure} \usepackage{color}
...
Distributed filesystems % are a tool for grid developers that simplying
...
\includegraphics{CloudStoreTest.pdf}
