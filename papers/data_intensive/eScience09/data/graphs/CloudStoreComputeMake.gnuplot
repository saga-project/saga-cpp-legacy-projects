...
set mxtics 5
set mytics 5
plot[0:8][0:2000] './CloudStoreComputeLocal.dat' using 1:2 title 'C1 - [144 MB; E(Y, Y), P(N, N); CloudStore; Direct; 1]' with lp lw 3,\
'./CloudStoreComputeRemote.dat' using 1:2 title 'C2 - [144 MB; E(Y, N), P(N, Y); CloudStore; Direct; 1]' with lp lw 3,\
'./CloudStoreCompute2Chunkservers.dat' using 1:2 title 'C3 - [144 MB; E(Y, Y), P(Y, N); CloudStore; Direct; 2]' with lp lw 3,\
