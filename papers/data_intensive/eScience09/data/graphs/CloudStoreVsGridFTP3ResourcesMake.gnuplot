...
set mxtics 2
set mytics 5
plot[0:9][0:750] './CloudStore3Mach3R.dat' using 1:2 title 'S0: [C5, {/Times-Italic r} = 1]' with lp lw 3,\
'./IntelligentGridFTP3Resources.dat' using 1:2 title 'S1: [C5, Intelligence]' with lp lw 3
