...
For this project we will estimate we will need a relatively small allocation, 0.25M SUs. This small allocation will be used with in conjunction with the allocation from other project (Community Code Development) to run distributed ensembles of REMD simulations distributed resources.% on Kraken, Ranger, Lonestar, Blacklight and Trestles. Table~\ref{table:project3} shows the breakdown of requested SUs for this project.
