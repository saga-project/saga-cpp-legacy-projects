...
In Figure 6, we show the scaling performance with MD simulation package such as NAMD.  When using 32 cores, the time taken per step is approximately 0.06s; thus the wall clock time required to complete 1ns is .34 day; in other words for a 56K system, 1 ns simulations require $\approx$ 300 CPU hours. Thus each 100 ns simulation requires approximately 30,000 CPU hrs. In Table 2, estimated CPU costs are shown.  We expect 750,000 SU are needed for this project.
...
SAM-I & PCA/Clustering &  AMBER and scripts &  50,000\\
SAM-II &MD &  NAMD &  15,000\\
SAM-II & MM-PBSA & NAMD & 15,000 \\
SAM-II & PCA/Clustering & AMBER and scripts & 50,000 \\
SAM-II & REMD &  NAMD &  450,000\\
SAM-III &MD &  NAMD &  30,000\\
SAM-III & MM-PBSA & NAMD & 30,000 \\
SAM-III & PCA/Clusetring & AMBER and scripts & 50,000 \\
\hline
\end{tabular}
\end{center}
\end{table}
...
an additional 64k-96k SUs, placing the total in the range of 122k-144k SUs for a single complete reservoir study.
