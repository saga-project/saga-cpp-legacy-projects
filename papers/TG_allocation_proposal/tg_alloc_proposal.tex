...
\author{Principal Investigaor: Shantenu Jha$^{1,2}$\\
...
\author{Co-Principal Investigaor: Joohyun Kim$^{1}$\\

   \small{\emph{$^{1}$Center for Computation \& Technology, Louisiana State University, Baton Rouge, 
USA}}
\\

\author{Co-Principal Investigaor: Yaakoub El Khamra$^{1}$\\
...
\subsection*{Project 2: Computational Study of Conformational Switching S-box Riboswitch}

%Increasing attention has focused on targeting RNAs for drug design~\cite{foloppe}. 


With increasing evidence indicating a critical role of RNA in transcriptional regulation and
translational regulation, increasing attention has focused on the potential of targeting RNA for drug
design~\cite{foloppe}.
However, because 
RNAs are flexible and highly negatively charged, there are still some puzzles about how small molecules 
...
In the future, MM-PBSA (Molecular Mechanics - Poisson Boltzmann Surface Area) will be
adopted to estimate the total binding free energy in term of distinct contributions with explicit physical
meaning.
...
algorithems and other applied mathematical algorithms will be applied to analyze MD trajectories.
