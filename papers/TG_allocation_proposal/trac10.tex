...
As stated, one notable direction we want to explore with this request is to implement GPU accelerated RNA secondary structure prediction and sampling programs.  We will test our implementation with Lincorn cluster and our request includes computational time with the cluster machine. This development is eventually integrated into the pipeline that becomes to support many levels of parallel implementation with heterogeneous HPC resources for the research of RNA folding and structure information.
