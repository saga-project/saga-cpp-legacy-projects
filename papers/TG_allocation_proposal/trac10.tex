...
Initial results from Project 1 supported by an earlier TRAC award was selected as the cover article of a leading scientific journal~\cite{jctc\_cover}.
...
\begin{figure}[!h]
  ...
  \caption{Figure representing the starting configuration of a 3\prim
    led \atf translocation simulation~\cite{jctc\_cover}. The
