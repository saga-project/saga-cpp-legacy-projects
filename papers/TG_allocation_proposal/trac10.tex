...
\jhanote{for consistency of style.. please use sci. obj and computational requirement}
...
\begin{table}[h]
\begin{center}
  \caption{Riboswitch simulations and expected computing resources. Note that the estimated SUs for MM-PBSA calculation is about the additional MD simulation with the SAM-free RNA system \jhanote{Please update \jhanote{We need to specify the machines that we want to use in the table. Again see Projects 3 and 4 for consistency}} }
\label{table:systems}
