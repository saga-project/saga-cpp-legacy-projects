...
sequestration ~\cite{GeoRPT,Luigi}. To that end, some of our efforts are directed towards 
...
the use of Ensemble Kalman filters (EnKF) ~\cite{KalmanPaper, DO2007, LiEnKF07, DO2006}
...
\cite{Zhang,White1987,Durlofsky1992}.
...
can ``cross''  the sub-ensembles gains \cite{Mitchell02}
