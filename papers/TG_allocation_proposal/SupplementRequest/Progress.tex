...
\subsection{Project 3b: Predicting the affinity of the EGFR kinase domain for drug inhibitors of lung}
...
\subsection{Effects of Varying Mineral Surface Charge on RNA Adsorption, and Rate of Folding}
...
\subsection{Enhanced folding of large RNA ribozymes using Replica Exchange Molecular Dynamics}
