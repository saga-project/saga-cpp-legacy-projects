...
Table~\ref{table:tab1} shows the current status of the main stages of the projects in the allocation and the estimated computational requirements. The resource justification follows in the next section. In summary: we request 1 million SUs on ranger and 1.5 million SUs on Kraken.
