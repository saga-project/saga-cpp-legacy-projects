...
\begin{figure}[htbp]
	...
	The time to complition of 8 replicas depends on a size of a Condor pool. To avoid
...
often occured in real, was avoided in purpose to obtaine comparable results,
...
\begin{acknowledgement} 
  \up \footnotesize{Important funding for SAGA has been provided by
    ...
    SciencCloud for Nimbus resources.}
\end{acknowledgement}
