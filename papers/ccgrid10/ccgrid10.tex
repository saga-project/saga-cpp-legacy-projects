...
Infrastructures (PGIs), but so do the Programming Systems and 
Tools (PS\&T) used to develop distributed applications need to account for {\it fundamental}
characteristics.
...
ser applications, but it also commonly
