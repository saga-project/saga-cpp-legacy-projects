...
characteritiscs of applications that motivate their usage as a
...
a large number of lesser, well-known applicaitons that have either
...
interoperability.  % The lack of reusability and
% extensibility thus has the effect of further suppressing distributed
...
\jhanote{Discuss PilotJob: (i) How Traditionally Used (mostly deployment time);
...
As more applications try to take advantages from dynamic
...
This in turn is where autonomic features and the abilty to easily
extend capabilities to the exsiting framework will play important
roles.
