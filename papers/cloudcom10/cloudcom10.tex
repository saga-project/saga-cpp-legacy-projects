...
the API. \jhanote{Andre: Please check this makes sense?} \alnote{make sense and is correct. Just a note: the API is SAGA style and actually uses some SAGA classes, e.g. saga.job.description. But I think this does not need to go here.}
