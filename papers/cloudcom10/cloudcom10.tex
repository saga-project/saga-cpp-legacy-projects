...
Download test file from datacenter within same affinity group
and from other data centers
...
the time for 4 generations, i.\,e.\ for 64 attempted exchanges.
...
- Affinity group: US vs. Asia vs. EU
- Transfer times between regions
- Test the different abstraction
