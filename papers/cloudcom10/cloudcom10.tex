...
\begin{abstract}
  ...
  functionality provides \jhanote{comparable to toher grid and cloud
    offerings} performance for loosely-coupled applications.  \up \up
...
% achieved.
The best result (approx. 12 MiB/s) % \jhanote{12MB/s?}
...
SAGA adaptors to important Azure services. \jhanote{this is a
  candidate for shortening. maybe just focus on the joint grid-cloud
  capabiltiy that saga-azure would provide}
