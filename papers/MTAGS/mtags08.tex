...
LONI~\cite{loni}.  The RE-Manager has in particular been tested on
QueenBee (QB).  In particular, the scalability of the Glide-In
framework has been extensively tested.
...
machine by avoiding queuing times for every sub-job and allowing the
...
framework can efficiently dispatches RE sub-jobs providing an enhanced
