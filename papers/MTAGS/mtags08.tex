...
loosely-coupled but heterogenous sub-tasks.

In the latter case, they are not only heterogenous they are also
highly irregular and both applications need to be adaptive to dynamic
changes in order to function effectively.

% We have demonstrated that these applications work
