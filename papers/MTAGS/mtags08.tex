...
\begin{abstract}
  ...
  distributed applications. In particular it is an effective tool for
  implementing the coordination and orchestration of dynamic
  applications, with possibly distributed many-tasks, whilst keeping
...
simple parameter sweeps. However, there exist a large class of
...
with the size and the number of sub-tasks, the nature of coupling
