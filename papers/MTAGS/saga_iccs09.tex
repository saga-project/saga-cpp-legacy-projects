...
\author{Shantenu Jha\inst{1,2}, Yaakoub El-Khamra\inst{1}, Joohyun Kim\inst{1}, Andre Luckow\inst{3}}
...
\begin{abstract}
  ...
  Applications (SAGA) can be used to develop a very wide-range of
  distributed applications with agile execution models. In particular
  SAGA is an effective tool for coordinating and orchestrating dynamic
  applications with many sub-tasks, possibly distributed, whilst keeping
  the application agnostic to the details of the infrastructure used.
  Specifically, in this paper we describe how SAGA has been used to
  develop applications from the following classes of distributed
  applications: (i) applications with loosely-coupled homogeneous
  sub-tasks and, (ii) applications with loosely-coupled heterogeneous
  sub-tasks. We also analyse and contrast the application
  characteristics and coupling of the sub-tasks.  As we will show,
  applications with multiple sub-tasks often have dynamic characteristics, and
  thus require support for both infrastructure-independent programming
...
\begin{figure}[htbp]
  ...
  \subfigure{\includegraphics[width=0.5\textwidth]{perf_repex.pdf}}
