...
\title{
  ...
  Simple and Standard Programmatic Interface}
...
\begin{abstract}
  ...
  applications with many-tasks, possibly distributed, whilst keeping
  ...
  applications with many-task often have dynamic characteristics, and
...
% using general purpose grid infrastructure 

% Our experiences are consistent with the fact that it is 
%~\cite{TeraGyroid}
...
\begin{figure}[!h]
  \begin{center}
    \subfigure{\label{sagalayer1}
      \includegraphics[width=3.33in]{saga_layered_landscape}}     
  \end{center}
...
%when running concurrent sub-tasks of 
