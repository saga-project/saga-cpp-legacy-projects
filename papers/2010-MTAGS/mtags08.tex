...
\begin{figure}[htbp]
    \centering
        \includegraphics[width=0.45\textwidth]{remdmanager_v11}
...
\begin{figure}[htbp]
        \includegraphics[width=0.5\textwidth]{perf_glidein}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{kalmanfilterlayer}
