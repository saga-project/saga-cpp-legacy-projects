...
Once the user does install DARE he will be able to access an executable called 'dare-run' . this executable takes an input file with '.dare' as an extension. A DARE should be know and be able to understand the following 3 different files.
