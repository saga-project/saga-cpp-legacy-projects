...
With two examples, we want to address how DARE has been used to construct gateways, particularly focusing on i) specific science capabilities (ii) features as a framework that can be used efficiently to build a gateway, whose current core implementation is primarily positioned in L2 and L3 (iii) specific problems solved, with which unique advantages of DARE-based gateways for large scale compute-intensive as well as data-intensive services are highlighted.
