...
distributed execution of applications on HPDC infrastructure.  Before
we present details of the DARE framework, we discuss the ``D'' in
...
pilot-jobs, in particular the SAGA-based pilot-job (BigJob).
