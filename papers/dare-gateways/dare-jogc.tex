...
\title{Dynamic Application Runtime Environment (DARE): A
  Standards-based Framework For Gateways}
...
\section{NEED OF GATEWAY FOR LIFE-SCIENCE APPLICATIONS} 
...
\section{DARE -- A Critical Abstraction: The Need for a Common
  Substrate for Gateways}
...
\subsection{SAGA and SAGA-based Pilot-Job}
...
\subsection{Three Layers Architecture of DARE-based Science
  Gateways}
...
\subsection{EXAMPLES OF DARE-BASED GATEWAYS FOR LIFE SCIENCES}
...
\subsection{NGS Analytics: TYPE I, II and III Services}

\subsubsection{Type I} \jhanote{JK: Cut n' Paste}

\subsubsection{Type II} \jhanote{JK: Cut n' Paste}

\subsubsection{Type III} \jhanote{Mark}
