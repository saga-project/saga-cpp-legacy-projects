...
extensible capability were provided this {\it gap} could be overcome.
 ...
 \jkimnote{the following is from Nancy Wilkins-Diehr paper and her observation is needed to be combined with the above} According to the recent report\cite{gce11-nancy}, compared to 10 gateways consuming 100,000 CPU hours in 2006, in 2010, 22 gateways provides 40 million hours usage via TG.  Interestingly, by 2011, nearly 40 \% of users on TG came through gateways and it is notable that the CIPRES phylogenetic gateway accounts for 25 \% of all TG users. 
...
transition to eXtreme Science and Engineering Discovery Environment (XSEDE), such requirements
