...
\title{Distributed Application Runtime Environment (DARE): A
  Standards-based Middleware Framework For Developing Science
  Gateways}
...
%   for both compute and data-intensive applications.
  ...
  \begin{abstract}
    ...
    production cyberinfrastructure such as the TG/XSEDE.  Currently,
    there does not exist a commonly usable middleware to seamlessly
    integrate different gateways to a range of distributed and
    ...
    not scalable without a effective and extensible middleware.
    Challenges that make using production cyberinfrastructure as a
