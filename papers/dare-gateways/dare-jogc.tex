...
\jhanote{Please structure the discussion with some flow.  Define what,
  then how!} DARE-API is available for user installation and one can
...
\jhanote{what are these configurations of?}  which are necessary to
execute a workflow on distributed machines.
...
Job) \jhanote{P* undefined!?} by combining user customized
configuration files. 
