...
\textit{Runtime System (L3):} \jkimnote{will revise this} The challenges in building a scalable
...
\textit{Resources (L4):}  \jkimnote{everyone, need to revise this}  While the utilization of distributed
...
user (or gateway developer) wants to use DARE, all they have to do is
run the DARE image on Quarry and setup their credentials.

It is important to note that the deployment and utilization model for
DARE shifts the deployment and development effort from gateway developer
to regular XSEDE users. With basic understanding of gateways, a user can start
