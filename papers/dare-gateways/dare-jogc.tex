...
The important feature of DARE is to utilize different distributed resources and this complexity involving the execution of 
...
The tasks and input/output files will be distributed over different machines and DARE needs to keep
track of them. 
Before DARE-API submitting the next tasks to the P*-API,  DARE-API should check for the status of its dependent task.
