...
\begin{figure}
  ...
  \caption{\small \jhanote{Use updated figure}(left) Overall architecture of DARE-based gateway revealing four levels.  (right) Different Illustration of a DARE-based gateway architecture}
  \label{fig:dare-arch} 
\end{figure}
...
hassles due to reliance on DARE, i.e. the SAGA/SAGA-based runtime environn framework.
