...
The introduction outlined that building effective science gateways has two major
...
or it may in turn be used as a primary building block for science gateways, that
provides simple and scalable integration with the HPDC infrastructure.
Details of the science gateway built using DARE are provided in \S3.
...
question. SAGA~\cite{saga_url} is an Open Grid Forum (OGF) Technical Specification that
...
OGF standard. The standardization is important
...
access layer for the \$121M NSF TG/XSEDE project[cite XSEDE]~\yyenote{Need to cite XSEDE}, as well
as for the world largest distributed infrastructure EGI[cite EGI]~\yyenote{Cite EGI}. The
