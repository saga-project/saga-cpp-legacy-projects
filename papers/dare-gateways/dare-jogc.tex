...
ability to support dynamic execution patterns and workflows.  Using
...
\subsubsection{Support for Dynamic Execution: SAGA-based Pilot-Job}
...
%   from the TG'11/ECMLS paper please} 


% ~\yyenote{I am keeping the previous
...
component. For data management, SAGA-BigData(Pilot
Data)~\cite{pstar11} is being actively developed in parallel to BigJob
which is used in DARE as well.
