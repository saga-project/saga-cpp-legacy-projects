...
\end{itemize}
 ...
 \subsection{Frameworks}
  ...
  %%-------------------------------------------------------------------------%%
  \subsection{SAGA Software Development and Lifecycle}
  ...
  \jhanote{We need a subsection on regression
  ...
  % - SAGA itself can serve as vehicle for testing
  % - even if we did not implement anything, we can document what we
  %   now, in hindsight, find important in repsect to testing.


  
  \subsection{Package and Delivery} 
 ...
 \subsection{Community Uptake?}
   ...
   % - spec uptake, influences, etc.\\
   % - Implementation uptake, deployments, etc.\\
   % - contributed adaptors, etc.\\

   % - organize discussion around user communities\\
   %   - domain scientists / end users \\
   %   - tools/framework developers \\
...
\section{Prior and Related Work}
 ...
 \subsection{APIs for Distributed Functionality}

  GAT, DRMAA, BES, Globus-API, CoG, ...


 \subsection{Tools and Frameworks for Cyberinfrastructure}


 \subsection{Access Layers to Cyberinfrastructure}
