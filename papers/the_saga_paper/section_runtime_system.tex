...
% Design pattern: plugin, pimpl
  ...
  %%%%---------------------------------------------------------------------%%%%
  \subsubsection{\thesagaimplrt}
  \onote{After some research I have come to the conclusion that the correct
  term for the "Engine" or "Core" is Runtime Support System (RTSS). It is not
  confined to compilers and languages at all (google it). Unless somebody
  doesn't like the term, we should stick to it once and for all.}\\
