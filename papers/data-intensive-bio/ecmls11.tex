...
case so ten temporary, some more temporary files depending on the \texttt{-d}
option while preparing indexes (for example, with $d=0$, 1 temporary file is created, and with $d=1$, 4
