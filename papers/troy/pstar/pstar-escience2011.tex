...
\item \textbf{Pilot-Job (PJ):} The PJ (also referred to as pilot) is
  ...
  Commonly, the PJ utilizes an agent to manage the set of allocated
  resources. Depending on the context, PJ also refers to the concept
...
workload is either specified completely independent of a (specific)
resource or just partially.  \alnote{Question: Is the time of binding
...
\footnotesize{This work is funded by Cybertools project
  ...
  award TG-MCB090174 (Jha). } \bibliographystyle{plain}
