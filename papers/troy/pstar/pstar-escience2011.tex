...
BigJob Manager is responsible for the orchestration and scheduling of the PJs
...
the manager in the same way. Currently, a simple binding mechanism is used: each
WU (a task) submitted to the BigJob framework is mapped to one SU (a so called
sub-job). Binding takes places at submission (early binding). For scheduling a
