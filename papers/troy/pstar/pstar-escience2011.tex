...
probabilty will first be 1.  Multiple approaches exist to support
...
(section~\ref{sec:pilot-model}) using SAGA. As shown in
Figure~\ref{fig:figures_troy} the framework is located on top of the
...
maintains the SAGA Look \& Feel and was designed to be similar to SAGA
in appearance and philosophy: it re-uses many of the well defined (and
standardized) semantics and syntax of the File, Job and Advert
API. Further, we aimed for a simple-to-use API exposing as least
amount of details necessary.  
