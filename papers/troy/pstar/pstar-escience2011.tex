...
\jhanote{(i) definition of pilot-job and SU very similar. (ii)
  ...
  motivation.(vii) US--> SU, US --> WU.} \jhanote{AL: Are these all
  addressed?}\alnote{not, yet, working on them}
...
coordinated. % The way the coordination between the different elements
