...
agent. The binding between UW and PJ takes places at submission. In addition to
the vanilla BigJob SAGA various other BigJob implementation exist, e.\,g. there
are specific BJ flavors for cloud resources as Amazon EC2 and Microsoft Azure 
that are capable of managing set of
VMs as well as as a BJ with a Condor-G based backend.
...
allows for dynamic resource additions and removals. The support of this feature
depends on the backend used. BigJob-SAGA utilizes the concept of a BigJob pool
to support elasticity: A BigJob pool consists of multiple BigJob-SAGA that can
be potentially distributed across several resources and types of
...
BigJob pool. BigJob pools are elastic, i.\,e.\ resources can added or be removed
at runtime. Various other backends support resource elasticity out-of-the-box,
e.\,g.\ DIANE and Condor.
...
% Data placement and locality is the key for a optimal 
