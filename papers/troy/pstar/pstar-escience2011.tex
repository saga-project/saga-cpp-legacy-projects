...
\textbf{Scheduling:} Task scheduling describes i) the process of
...
%   Model?}
The PJ implementation must define the usage model, i.\,e.\ how are
...
\begin{figure}[t]
	...
	a SAGA-inspired API for the management of PJs and PD. BigJob and BigData are 
...
\begin{figure}[htbp]
    ...
    \caption{\textbf{Pilot-Data Architecture:} The PD-Manager is exposing the 
...
Further, we also observed a runtime overhead of about 17\,sec for the BJ-DIANE
scenario. This overhead is likely caused by the additional agents that need to
be run.
...
EGI and TG resources. Dynamic applications can utilize the elasticity of the
...
Management API~\cite{saga_rm}. Further, we will investigate autonomic resource
