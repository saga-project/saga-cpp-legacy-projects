...
\textbf{Coordination:} describes how the various elements of a
PJ framework are internally coordinated. Coordination between
...
between the components of the framework, can be used: e.\,g.\ messaging 
