...
yet incompatible workflow systems.  There are multiple WF systems that
are not interoperable. Reasons are complex and can't be simplified;
maybe interoperability isnt what is desired, but reusability and or
ease of customisation. Given the proliferation of pilot-jobs, and
additional sophistication that can be built upon them, there exists a
similar risk...
