...
\begin{figure}[t]
  ...
  \upp
	...
	using two primary classes: The \texttt{Pilot\-Compute\-Service} for the management 
	of pilots, and the \texttt{Compute\-Unit\-Service} for the management of \cus.
...
\texttt{Compute\-Unit\-Service}. Each BFAST \cu requires 1 core; depending on the
