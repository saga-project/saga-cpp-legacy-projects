...
\newcommand{\ds}{Data Service\xspace}
...
% submit \cu s to the pilot-manager (step 5/6). A \cu  that is submitted
...
%   grouping or a smart aggregation of \cu s (e.\,g.\ two sets of
...
% the management of affinity between DUs and also between \cu s and
