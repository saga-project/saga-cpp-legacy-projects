...
To achieve interoperability, we developed a Pilot-API interface to all
...
XSEDE~\cite{xsede} and with the PBS/SSH plugin to access the India
machine on FutureGrid~\cite{fg}. For OSG we utilize a BJ
implementation on top of the SAGA/Condor adaptor.\note{Refine:
  GlideWMS, ...}  resources~\cite{1742-6596-78-1-012057}. Further, we
