...
pilot-job abstractions.  The P* Model provides a conceptual basis
...
A \texttt{PilotCompute} instance is returned as result of the
...
\texttt{PilotCompute} instance is done by using a
...
Finally, an application can have any number of \texttt{PilotComputeService} or
\texttt{ComputeUnitService} instances.
Multiple \texttt{PilotComputeService} instances can be associated to a
\texttt{ComputeUnitService}, and a \texttt{PilotComputeService} can be associated to
