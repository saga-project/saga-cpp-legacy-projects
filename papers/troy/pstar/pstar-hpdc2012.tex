...
\note{OW says: Where is that magic BigJob-Pool and its scheduler? Is there an API for that? 
That's also part of the capabilites provided by bigjob-server.}
