...
%   (dynamically), and not just before execution (statically).
  Pilot-Jobs are aguably one of the most widely-used abstractions in
  many production distributed cyberinfrastructures.  They have been
  notable in their ability to effectively support distributed resource
  utilization, as measured by the number and types of applications
  that use them, as well as the number of production distributed
  cyberinfrastructures that support them.  Not suprisingly, there are
  multiple, distinct and incompatible implementations of pilot-jobs;
  often these implementations are strongly coupled to the distributed
