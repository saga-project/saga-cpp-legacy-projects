...
Pilot-API by demonstrating how Condor-G~\cite{condor-g} and
...
between different PJ frameworks -- BigJob and DIANE. We
...
\begin{figure}[t]
	...
	of pilots, and the \texttt{WorkUnitService} for the management of \cus. The 
...
binding and scheduling the \cus to the pilots. The application can monitor the
state of the PJs and \cus using the Work Unit Service of the TROY API.
