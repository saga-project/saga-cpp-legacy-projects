...
\jhanote{Can we at least say there is trivial one-to-one mapping
  between native BJ API and Pilot-API, i.e.  semantically identical
  only differences are syntactical?}
