...
different PJ frameworks: BigJob, DIANE, Condor-G and infrastructures: XSEDE, 
FutureGrid, EGI and OSG.  For each of the frameworks we provide an 
implementation of the Pilot-API. For the experiments we rely both on the native 
and Pilot-API.
