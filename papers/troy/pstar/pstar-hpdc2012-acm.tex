...
\begin{abstract} 
 % Distributed cyberinfrastructures (CI) and applications require the
  ...
  defined, unifying conceptual model of pilot-jobs which can be used
...
\begin{lstlisting}[caption={Instantiation of a \texttt{PilotComputeService} using a \texttt{PilotComputeDescription}.}, label={lst:pcs_creation}]
...
\begin{minipage}{0.45 \textwidth}
\begin{lstlisting}[caption={Instantiation and submission of a
\texttt{ComputeUnitDescription}.}, label={lst:submission}] 
