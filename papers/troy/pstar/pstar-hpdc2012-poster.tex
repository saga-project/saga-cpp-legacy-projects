...
%Andre Luckow$^{*}$ &Mark Santcroos$^{**}$ &Ole Weidner$^{**}$ &Andre Merzky$^{**}$ &Sharath Maddini$^{**}$ &Shantenu Jha$^{***}$\\
%\end{tabular}

%\centering
%\begin{tabular}{ccc}
%$^*$Center for Computation \& Technology &$^{**}$Bioinformatics Laboratory &$^{***}$CAC/ECE\\
%Louisiana State University &Bioinformatics Laboratory &Rutgers University\\
%Baton Rouge, LA &University of Amsterdam &Piscataway, NJ\\
%\end{tabular}
%\end{table*}
...
\begin{abstract} 
  ...
  for the P* Model (Pilot-API), and (iv) validate the implementation of
...
\alnote{Remove Pilot-Data from introduction...}
