...
set ylabel "Time (seconds)" font "Helvetica,15"

#set datafile separator "," 
set style data histogram
set style histogram rowstacked #gap  3 title offset character 0, 0, 0
set style histogram errorbars 
#set xtic rotate by -45 scale 0
set auto x
set yrange[0:*]
set xtics ("BJ-SAGA" 0.5,"BJ-DIANE"1.5, "BJ-SAGA,BJ-DIANE" 2.5)
