...
concurrently. \pmnote{what figure does it refer to..Not sure what experiments done on Alamo?} This enables us to focus on the overhead induced by the PJ
...
jobs/tasks coordinated.\onote{Strong claim -- data doesn't show any significant
scale-up} Although we do not provide a detailed discussion of the dependency
...
\jhanote{Is this c\&c overhead?} \pmnote{what machines are used to run BigJob, are all these compute units executed concurrently using BigJob and Diane?} Figure~\ref{fig:perf_bigjob-varying-cores}
