...
be staged (1.9\,GB); this constiutes the most significant part of the
...
and one to FG/India.  The overall runtime is the sum of the file
staging and the actual compute time on the respective
