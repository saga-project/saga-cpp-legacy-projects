...
is designed as an extension of BigJob. Figure~\ref{fig:figures_bigdata}
...
frameworks.
\onote{We don't really 'analyze' anything here. We claim that there
is C-and-C and extrinsic factors. I also don't know if a discussion
of the C-n-C properties of DIANE and BigJob are sufficient to claim
that these are 'typical overheads for PJ frameworks'.}
