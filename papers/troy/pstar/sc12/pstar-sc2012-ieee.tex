...
are mostly insensitive to the number of coordinated \cus.\onote{Strong
...
for each \textit{short read} file (generated by the
DNA sequencing machine). For this configuration a total of 128 read
files (one per CU) is used.
...
enhance the range of applications and usage-modes that
