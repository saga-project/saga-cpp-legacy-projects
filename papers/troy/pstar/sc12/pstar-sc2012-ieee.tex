...
\begin{abstract} 
 % Distributed cyberinfrastructures (CI) and applications require the
  ...
  originally designed for. % there exist multiple distinct and
%   incompatible implementations of pilot-jobs.
  ...
  multiple {\it distinct} pilot-job frameworks on distinct production
