...
\subsection{Extending the Pilot-API for Data}\jhanote{I propose we
  call this Pilot-API for Data, not ``Extending''}
...
of tasks, existing coordination infrastructures suffice. \jhanote{We
  don't do the previous two sentences, do we?} In
