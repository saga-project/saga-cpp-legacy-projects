...
Using \pilotdata the overall amount of data that needs to be transferred for the
128 CU scenario is reduced from 243\,GB (i.\,e.\ 128\,\cus times 1.9\,GB data for
the reference genome, index files and 1 read file) to 24\,GB (a single transfer of 
the reference genome and index files and 1 read file per \cu, i.\,e.\ 128 
times 170\,MB ). The staging times in D2 and
