...
each). \jhanote{The numbers don't add up!! 32 files of 1.68GB is about
  50GB!}
...
they need to be staged for the DIANE/EGI \cus. \jhanote{without an
  explaination the previous sentence seems arbitary and difficult to
...
see where B1/B2 and C1/C2 etc are defined}\\ \\
