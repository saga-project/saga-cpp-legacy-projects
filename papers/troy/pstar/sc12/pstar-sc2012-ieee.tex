...
As an indication, a typical run of 128 CUs on OSG ended up being scheduled on
10+ sites spread over an equal amount of nodes per site.
\jhanote{Also, I'm concerned that we are conflating staging which is IMO
typically data transfer to the point of consumption, with 'disk I/O'}
