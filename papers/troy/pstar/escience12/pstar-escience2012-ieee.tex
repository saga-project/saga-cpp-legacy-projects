...
\includegraphics[width=0.48\textwidth]{../perf/bigjob-varying-cores-alamo-noadvert-scaled.pdf}
...
\begin{figure}[t]
	\upp
	\centering
		\includegraphics[width=0.37\textwidth]{../perf/sc/pd-128cus.pdf}
	...
	efficient transfer protocol.\up\up\up}}
...
The primary intellectual contribution of this work are (i) the
...
it presents, arguably the first time, an analytical framework upon
...
principle, i.\,e., because it ``exists, it must be correct''. One can argue
