...
addition, there is confusion about what constitutes a pilot-job
...
e.g., Glidein-WMS is often call the pilot-job, which is then logically
compared to DIANE or BigJob. Using the P* Model, one can address this
ambiguity and clearly establish that Glidein-WMS provides a specific
{\it scheduling} characterstics for an implementation of the
Condor/glide-in pilot-job. Similarly BigJob could be used with
different {\it coordination} characteristics or implemenation.
...
rather than a loosely-defined capabilty validated by a weak existence
...
unifies job and data abstractions, via the notio of an extended and
...
addressing deployment barriers towards interoperabilty.

\jhanote{Last but not least .. discussion and validity to Clouds. To
  be addressed}

P* provides significant future development \& research opportunities,
e.g., ability to experiment and reason on the relative roles of system
