...
The Pilot-API~\cite{bigjob_web} has been deployed to support production-scale 
...
capabilities with multiple production infrastructures. However, attention to 
several deployment issues is required to realize the full power of the 
P*/Pilot-API. For example, in spite of a common Pilot-API, each PJ framework 
has a rather different usage modality; this is reflective of the fact that 
typically, PJ frameworks ``evolve in'' and are ``native to'' specific 
...
WMS. Additionally, our experience with fragile grid middleware and 
