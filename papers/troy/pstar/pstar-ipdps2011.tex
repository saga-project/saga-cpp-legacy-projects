...
paper, an agent refers to a ``proxy process'' that aids the
implementation one or more of the characteristics of a P* Model --
coordination, communication, scheduling, within a pilot-job framework.
These agents can be used to enforce, a set of (user-defined) policies
(e.g.  resource capabilities, data/compute affinities, etc.) and
heuristics.
...
utilizing up to 128 cores concurrently. Each experiment is repeated at least 10 
times.
