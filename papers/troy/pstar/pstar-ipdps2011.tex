...
\begin{figure}[htbp]
    ...
    \caption{
      ...
      binds it to a SU and schedules the SU to an available
...
the Redis backend show a linear scalability up to 128 cores. Similarly, the 
Advert backend showed a significantly lower performance.
