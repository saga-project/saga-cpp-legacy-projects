...
\note{OW says: We seem to have this obsession with the word 'framework'. }
...
To validate the interoperable features of the abstractions developed, 
we conducted a series of
experiments. We execute BFAST~\cite{bfast2009} -- a genome sequencing
application -- using TROY API in conjunction with different PJ frameworks
and infrastructures. For this purpose we us the TROY API with 
BigJob and DIANE. TROY-BigJob is used with the
...
\amnote{TODO: the par. above needs to be cleaned up}
