...
understanding of dynamic execution\jhanote{What is DE?}.\alnote{dynamic 
execution} This will motivate an
...
A DU correspond to a WU in the PJ framework. \jhanote{PJ Model is
  confusing. Either it is P Model or PJ Framework} \alnote{ok} A particular
