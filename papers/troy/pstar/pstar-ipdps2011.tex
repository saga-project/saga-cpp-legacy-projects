...
\item \textbf{Pilot-Manager:} The PJ manager is responsible for
  coordinating the different components of the framework, i.\,e.\ the
  pilots, WUs and SUs. A PJ manager can generally manage multiple
  pilots. \jhanote{How about saying that it is responsible for
