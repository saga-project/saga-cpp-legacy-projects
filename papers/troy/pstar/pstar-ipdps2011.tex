...
Commonly, the Pilot-Manager can be accessed via a set of command line tools
...
A PM usually  manages a resource pool consisting of 1 or more pilot-jobs.
Most \alwave{PJs} utilize a M/W coordination model, i.\,e.\ the manager
tightly controls the actions of a set of workers (agents) located on the 
resource. However, the integration of more decision capabilities into the 
agent can yield to a more autonomic and adaptive behavior as well as a better 
scalability.   
