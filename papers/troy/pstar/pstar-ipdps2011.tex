...
of our work. TROY is positinoned to be used on every major national and
...
leads to analogous abstraction to the pilot-job: the \emph{pilot-data
  (PD)} abstraction, and the introduction of the BigData concept in  \
\S\ref{sec:pilot-data}.  

\alnote{doesn't sound right: With
...
elaborate on why python} Figure~\ref{fig:figures_troy_flow} illustrates the
typical interactions between the TROY elements.
