...
particular we focus on BigJob, DIANE and Condor-G. 
...
As summarized in table~\ref{table:bigjob-saga-diane}, we show that the elements
P* model can be mapped to these frameworks. Further, we compare the
characteristics of the four PJ frameworks in
table~\ref{table:pilot-job-comparison}. In addition to applying the P* model, we
integrated BigJob, DIANE and Condor into TROY in order to validate i) the TROY
abstractions and ii) the extensibility of the TROY framework.
...
\subsection{Characterizing TROY-PJ Implementations}
...
potential to ameliorate this situation.  % While much of our work has
...
\note{Future Work: 
TROY - tests on scalability and direct DIANE/Condor-G adaptors (more dev work)
Claim BigData and BigJob into TROY and provide a unified
Explore application with dynamic execution requirements: explore various kinds 
of dynamic execution and trade-offs
}
