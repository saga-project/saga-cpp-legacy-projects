...
provided by the P* model. \jhanote{Note the distinction between
...
framework, can be given a well defined API via the TROY API. To
...
\item \textbf{Work Unit (WU):} \alnote{Are we submitting to the PJ
    framework or Pilot-Manager?} A WU is a resource request which
