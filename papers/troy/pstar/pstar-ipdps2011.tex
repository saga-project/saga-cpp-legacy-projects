...
for computational science and engineering applictions.
...
rolled-out their own PJ abstrctions. The fact that users have voted
...
different pilot-job instances concurrently. In \S{V}, we charactertize
...
The \texttt{Work Unit Service} is responsible for managing the execution
...
In summary, TROY i) provides a unified API to various PJ frameworks
(e.\,g.\ BigJob, DIANE and Condor-G), and ii) enables the concurrent
usage of multiple PJ implementations (see
...
API extension to SAGA (see future work, \S{VI}).
