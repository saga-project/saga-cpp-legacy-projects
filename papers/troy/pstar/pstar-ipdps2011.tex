...
resource via the pilot. An SU consists of one or more WUs that are combined
inside the \alwave{PJ framework}. Note that that this can either be a simple
...
runtime increase only slightly (~10\,sec) when going from 64 to 2048 WUs. A
...
As in the last experiment, the Advert c\&c sub-system showed a significantly lower performance.
