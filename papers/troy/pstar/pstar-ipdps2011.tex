...
executing WUs is minimal. When the number of WUs is low, BJ can batch WU; 
thus, the increase is less than linear.

\begin{figure*}[htbp] \centering
\includegraphics[width=0.46\textwidth]{perf/bigjob-varying-wus.pdf}\qquad
\includegraphics[width=0.46\textwidth]{perf/bigjob-varying-cores.pdf}
