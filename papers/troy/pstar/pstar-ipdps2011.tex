...
implementations in particular BigJob and DIANE. Further, we investigate PJ
framework interoperability by using TROY in conjunction with different adaptors. 
For this purpose we utilize TROY with BigJob (with SAGA/PBS and 
SAGA/Condor) and DIANE concurrently in a genome sequencing application scenario.
