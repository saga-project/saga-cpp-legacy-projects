...
the PJs and WUs using the TROY API.

\begin{figure}[t]
	\centering
		\includegraphics[width=0.4\textwidth]{figures/NewTROYData.pdf}
...
Figure~\ref{fig:perf_perf-bfast-bj} shows the results of the experiments. The
runtime for TROY-DIANE is about 70\,sec longer than for TROY-BigJob. The main
...
the additional agents required.
