...
\item \textbf{Work Unit (WU):} \alnote{Are we submitting to the PJ
    ...
    change?} A WU is a resource request which encapsulates a
  self-contained piece of work that is submitted to the PJ framework.
  The PJ framework schedules that WU on the resources managed by its
  RMs, i.\,e.\ the framework determines what resources the WU will
  receive.
