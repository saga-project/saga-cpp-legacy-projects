...
\setlength{\parskip}{0.2ex} % 1ex plus 0.5ex minus 0.2ex}
...
SWIFT Costers~\cite{coasters}. The same applies to the P* characteristics that
...
multiple PJ frameworks. This validates i) the TROY abstractions and ii) the
extensibility of the TROY framework.


\alnote{this paragraph can go into VII or V}
\note{TROY provides a unified API that can be used to expose various PJ
