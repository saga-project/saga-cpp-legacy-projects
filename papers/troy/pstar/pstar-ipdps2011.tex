...
As summarized in table~\ref{table:bigjob-saga-diane}, we show that the elements P* model can be mapped to these frameworks. Further, we compare the characteristics of the four PJ frameworks in table~\ref{table:pilot-job-comparison}. In addition to applying
the P* model, we integrated BigJob, DIANE and Condor into TROY 
in order to validate i) the TROY abstractions and ii) the
