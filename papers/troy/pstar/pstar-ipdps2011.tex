...
The API classes and interactions are designed to reflect the P* elements and
characteristics. Table~\ref{table:pstar_elements} summarizes the mapping of P* elements and TROY components. The elements that do map one-to-one are the Work Unit and the Scheduling



The process of resource assignment (step 1-3 in
...
TROY utilizes a hierarchical M/W pattern. The TROY runtime 
system controls a set of PJ frameworks via their TROY adaptors. Inside the PJ 
framework another coordination model can be used; most commonly this is also 
M/W. The TROY runtime system only utilizes local communication channels between 
the application, the runtime system and the adaptors. Again PJ frameworks can 
rely on a communication subsystem of their choice.
