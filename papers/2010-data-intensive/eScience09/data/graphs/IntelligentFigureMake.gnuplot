...
set mxtics 2
set mytics 5
plot[0:10][0:2000] './IntelligentGridFTP.dat' using 1:2 title 'S0: [C4, Heuristic]' with lp lw 3,\
'./MixedGridFTP.dat' using 1:2 title 'S1: [C4]' with lp lw 3,\
'./IntelligentGridFTP3Resources.dat' using 1:2 title 'S2: [C5, Heuristic]' with lp lw 3,\
