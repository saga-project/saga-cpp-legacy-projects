...
\section{The SAGA Landscape}
 ...
 \subsection{Important SAGA Deployments}
  ...
  While SAGA is relatively easy to deploy in applications space
  (i.e. user space), its overall goal of improving the end user
  experience of distributed systems benefits greatly from system level
  installations.

 \jhanote{Mention how we are working to make it a Debian/Ubuntu
    Package}
 \jhanote{Integrating with NMI Build \& Test for different platforms}
