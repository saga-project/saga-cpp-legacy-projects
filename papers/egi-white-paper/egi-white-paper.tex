...
\jhanote{Need to make link to the UMD/EGI RoadMap Document. Simple
  statements about which functional capabilities are met and
  how.. Also relate to the EGI/UMD standards roadmap document
  (https://documents.egi.eu/document/206) }

\jhanote{DNA1.3.1 Technical Development Plan (EMI) v1.0 pg 25 (further
  objectives)}
