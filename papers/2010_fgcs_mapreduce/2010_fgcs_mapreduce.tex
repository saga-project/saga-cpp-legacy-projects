...
\miklosnote{Probably this sounds better than saying Hadoop is intrinsically linked to
HDFS. Any other ideas?}
...
\end{itemize}
\miklosnote{Andre: removed fail safety since it's not actually present...}
