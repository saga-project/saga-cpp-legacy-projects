...
% Using data-sets of size up to 10 GB, and up to 10 workers, we
...
\begin{table}[htb!]
  ...
  All times are in minutes, aggregated from 10 runs.
...
As evident from the data plots in \F{Figure xx} and \F{Figure yy}, certain behavioral 
...
notice are the two data points - 8 SPEs @ 64 MB chunk size in \F{Figure yy} 
and 8 SPEs @ 16 MB chunk size in \F{Figure xx}. Reducing the chunk size by 75\%, 
