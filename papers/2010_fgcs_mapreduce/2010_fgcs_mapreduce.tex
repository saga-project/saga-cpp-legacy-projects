...
\section{Application Performance Using SAGA-based Sphere and MapReduce}
...
{\it Experimental I -- Varying chunk sizes:}
...
experiments with Sphere \jhanote{Do you mean SAGA-based Sphere for
  Word-Count?} while keeping the chunk size constant at 64 MB, the
...
\section{SAGA-based Applications: Three Levels of Interoperabilty}
...
Case II:     Application 
          ...
          SAGA-Sphere  SAGA-MapReduce
            |            |
          OCC          Cluster/Clouds/Grids
              
Case III:   Application Instance
                |           
           SAGA-Sphere and SAGA-MapReduce
                |
        OCC and (Cluster/Clouds/Grids)
\end{verbatim}
