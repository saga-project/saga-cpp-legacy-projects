...
\institute{Andre Luckow @ Louisiana Statue University, Baton Rouge,
  USA 70803 \and Andre Merzky @ Louisiana State University, Baton
  Rouge, USA 70803 \and Miklos Erdely @ University of Pannonia,
  Veszprem, Hungary \and Shantenu Jha @ Louisiana State University,
  Baton Rouge, USA 70803}
...
\begin{figure}[t]
 \dnnn
 \includegraphics[width=1.0\textwidth]{saga-figure02.pdf}
...
% \includegraphics[width=0.5\textwidth]{figures/sagamr_comparison.pdf}
 \includegraphics[width=1.0\textwidth]{figures/sagamr_comparison.pdf}
 \caption{
...
\begin{figure}[htb!]
 \dnnn\dnnn
 \includegraphics[width=1.0\textwidth]{figures/sphere_mr_varying_chunksize.pdf}
 \caption{
...
\begin{figure}[htb!]
 \includegraphics[width=1.0\textwidth]{figures/sphere_varying_workers.pdf}
 \caption{
...
\begin{figure}[htb!]
 \dnnn\dnnn
 \includegraphics[width=1.0\textwidth]{figures/sagamr_varying_workers.pdf}
 \caption{
...
\begin{figure}%{R}{0.4\textwidth}
   \includegraphics[width=1.0\textwidth]{figures/re-azure}
...
\begin{figure}[ht]
 \centering
 \upp\upp
 \includegraphics[width=1.0\textwidth]{figures/cloud_ontology_apps}
