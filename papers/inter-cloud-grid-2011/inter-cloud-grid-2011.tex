...
\label{sec:gcinterop}
 ...
 usage of OCCI's automatic discovery and billig mechanisms.
 ...
 \amnote{check if OCCI needs extensions for job submission}
 \amnote{needs diagram (fig:arch1)}
 ...
 \amnote{needs diagram (fig:arch2)}
 ...
 in~\ref{fig:arch2} that OCCI can potentially be used to enrol complex
 ...
 (pervasive?) API which would allow to code 'native' applications
