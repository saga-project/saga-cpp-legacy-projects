...
\label{sec:intro}
 ...
 the European Grid Initaitive\ref{egi-www}.  We conclude the paper in
 section~\ref{sec:conc} where we also discuss alternative and
...
\subsection*{Cloud Interoperability and Standardization}
 ...
 well as the number of short reads, the application thus benefits
 from \BI{scale-up, scale-out, and data-compute co-location}.
 ...
 (at the data-center level).  We have shown that \BI{efficient
 coordination of application components} allows Ensemble MD to
 \BI{scale-up and scale-out}.
...
\subsubsection*{Understanding the Execution Patterns of the
 ...
 data-transfer and management issue, as long as \BI{data can be
 provisioned timely}.
...
\label{sec:gcinterop}
 ...
 The scale-up and scale-out requirements of this use case are similar to UC-1, and in fact likely similar to many cloud application use cases.  The coordination of application components is a core SAGA functionality, provided by the SAGA Advert API~\ref{advert}.
...
\bibliography{inter-cloud-grid-2011,../Compiled_bibentries/saga.bib}
\end{document}
