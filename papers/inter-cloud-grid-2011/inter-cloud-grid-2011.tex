...
OVF based formats. Since OCCI is an RESTful Protocol or API, it can
build upon all the features defined by HTTP. This includes mechanisms
for authentication and authorization, cache-mechanisms, content-type
...
Service API                                  & --          & SAGA                  & OCCI             \\\hline
Internal Interface for Resource provisioning & --          & OCCI                  & OCCI             \\\hline
Internal Interface for Job submission        & OCCI        & BES, DRMAA, SSH, OCCI & BES, DRMAA, OCCI \\\hline
