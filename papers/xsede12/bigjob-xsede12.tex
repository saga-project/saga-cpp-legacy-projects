...
\yyenote{Charles Laughton Sent this. Not sure if we can include it
  though (not ECSS)}
...
\end{tabular}
\caption{A subset of Jobs submitted as part of ECSS Project 1}
\label{table:results}
\end{center}
\end{table}
...
\end{tabular}
\caption{Jobs submitted by Dave}
\label{table:results}
\end{center}
\end{table}
