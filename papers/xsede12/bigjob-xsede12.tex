...
such as application-level scheduling.
\mrnote{Perhaps this excerpt from the pstar paper is of value? ``The abstraction of 
a Pilot-Job generalizes the reoccurring concept of utilizing a placeholder job
as a container for a set of compute tasks; instances of that placeholder job 
are commonly referred to as Pilot-Jobs or pilots.''}
