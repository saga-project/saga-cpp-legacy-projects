...
switches to present tense}\yyenote{project is mostly done but people still use
the tools}\mrnote{Fair... it is just a sudden switch when you are reading
the paper... not quite the Queen's English.}\yyenote{fair enough, fixed it in
the previous paragraph, essentially challenges wer ecircumvented, projects
overlapped and lead to increase efficiency, docs prepared are being used and
there was an increase in bugs reported. If you find other problems like this
please fix them, you have a good handle on things and we trust your judgement
(you are first author for a reason)}
...
% same as above rendered as table -- AM
\begin{table}
 \begin{center}
  \begin{tabular}{lrrr}
   \toprule
   \textbf{Machine } & \textbf{???} & \textbf{???} & \textbf{???}\\\midrule
   \textbf{QueenBee} &  186 &	 186 &  2.83\% \\\midrule
   \textbf{Cray    } & 2947 &	2947 & 44.77\% \\\midrule
   \textbf{Abe     } & 2350 &	2350 & 35.70\% \\\midrule
   \textbf{Ranger  } &  652 &	 652 &  9.91\% \\\midrule
   \textbf{Lonestar} &  447 &	 447 &  6.79\% \\\midrule
   \textbf{???     } & 6582 &       &      \% \\\bottomrule
  \end{tabular}
 \end{center}
\end{table}
...
%\jhanote{Is there an ECSS
%  award number that we should reference?}\yyenote{No}
