...
If these end users encounter any issues, the BigJob team works with the ECSS team to resolve the problem. In order to provide the fastest possible response time, a mailing list was utilized as a means of communication between the ECSS members, the BigJob development team, and any users of BigJob. The researchers also may have custom needs for their workflows, such as task restarts after a given number of time steps. If any questions arise during their implementation, the BigJob team is available to fully support  \mrnote{Does this make it seem like BigJob is not easy to use for the everyday guy?}
