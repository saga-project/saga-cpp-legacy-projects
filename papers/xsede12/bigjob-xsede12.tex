...
\begin{abstract}
  ...
  %to the seamless uptake of BigJobs.
\end{abstract}
...
\jhanote{just like tense toggling, the paper also toggles from first
  person plural to second person etc} \jhanote{was, ``We found
  ourselves with two..''}  

% This effort was the proverbial: ``two for the price of one''
% sort of undertaking. 
...
\subsection{ECSS Project 2: High Throughput, High Performance MD
  Studies of the Nucleosome using SAGA-based Pilot-Jobs}
...
ensembles, (iii) much larger data-volumes, (iv) BigJob \jhanote{not
  defined yet} infrastructure that currently does not support the
...
\caption{Configuration of Jobs submitted as part of ECSS Project
  2. \jhanote{Must provide units for the size}}
...
% Let me know if you need more details on the science. We are in the
% process of publishing some of the protease work (it is under review at
% the minute) would an 'In Review' citation be of any use to you?
...
% Table~\ref{table:results}, where several hundred independent analysis
% runs were conducted as part of the efforts to understand HIV drug
% resistance.

% \yyenote{Instead of the above paragraph, I wanted to substitute with this one}
