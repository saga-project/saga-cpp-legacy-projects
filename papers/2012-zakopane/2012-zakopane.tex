...
\begin{center}
 ...
 }\\[1em] {\footnotesize Shantenu Jha{$^*$}\footnotemark[1]$^{23}$,
   Hartmut Kaiser$ ^{25 }$ Andre Luckow$ ^{2 }$,\\ Sharath Maddineni$
   ^{2 }$, Andre Merzky$ ^{2 }$, Mark Santcroos$ ^{42 }$, Ole Weidner$
   ^{23 }$ \footnotetext[1]{ Rutgers University,~~ $^2$CCT, Louisiana
     State Univ.,~~ $^3$School of Informatics, Univ. of
     Edinburgh,~~\\ \sshift\shift $^4$Bioinformatics Lab., AMC,
     Univ. of Amsterdam,~~ $^5$Dep. of Computer Science, Louisiana
     State Univ.\\ } }
\end{center}
...
\begin{abstract}
 ...
 paper is to introspect and analyze the evolution of SAGA, and predict its 
 road ahead.
