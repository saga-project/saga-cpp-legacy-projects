...
the filesystem APIs are by far most relevant packages in broader user community. 
...
user community, are mostly attributable to this. Most of the remaining functionality of 
...
and other C/C++ libraries \hknote{what other libraries?} and the complexity of its build system, SAGA is difficult to deploy, 
...
just understand certain errors when they occur. \hknote{the code does not have 'many layers of indirection'. The main problems of understanding come from the used macros} 
...
(4) is not one of the points of criticism}
