...
outcome and design decisions would no doubt have been difficult. 
\alnote{difficult or different? difficult makes it sound as if this 
...
portals, gateways and runtime frameworks). \alnote{shall we define or reference a definition of PaaS/SaaS?}
...
\alnote{Do we also have a Retrospective on the implementation?}
