...
\documentclass[conference,final,onecolumn]{article}
...
% TODO (notes from call, 23.09.2011):
% 1.) What is the advantage of P*?
% beyond compare and contrast P implementations?
% Can we make the claim? By developing something: good design, good modularity
% Provides a good framework to develop on
% What is the practical argument for P*?
