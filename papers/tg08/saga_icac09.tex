...
\yyenote{Feel free to move this, this is what I want to say about Manish}
This certainly is not the first time autonomic frameworks have
been used to launch and manage reservoir simulations. Bangerth et al \cite{Manish}
used an autonomic framework to manage reservoir simulations for well-placement
optimization. At the moment, our work is focused on history matching
and reservoir characterization, however the next logical step
is to adapt Lazarus to run well/perforation placement studies. This might lead
to a convergence of SAGA and Accord in terms of common functionality
...
\yyenote{This entire section is bad, we probably should move
its bits about but as it stands it is meaningless}
...
\caption{Block Diagram outlining the basic structure of Lazarus. The
  ...
  (resource mapping strategy).  \jhanote{Color different, for
    ...
    side-by-side (v) explain arrows}\yyenote{Fixed, check out the pimped out color gradients} } 
\end{center}
...
Prof. Mayank Tyagi and Dr. Xin. The authors acknowledge the Texas Advanced Computing Center (TACC)
at The University of Texas at Austin, The LONI institute and NCSA
