...
0.75 is a justified good first approximateion -- as the bias in our
...
Represnetative hardware failures encountered:
\begin{itemize}
...
Represntative software environment failures encountered:
\begin{itemize}
...
\caption{Schematic diagram illustrating how a Cactus-based Resorvoir
...
\caption{
  ...
  at 2:00hours (although the chosen queue varies). So although there is not 
...
based framework provides support for advanced feateature that would be
