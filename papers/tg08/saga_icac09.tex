...
e did simple experiments to the test the dependence on the
confidence and quantile values; we find that the output is not very
...
%machine in conjunction with other machines
