...
\begin{figure}
\begin{center}
\includegraphics[scale=0.34]{./figures/perf-fig.jpeg}
\end{center}
\caption{From Left to Right: (i) Ranger, (ii) Queen Bee, (iii)Ranger+QueenBee, (iv) Ranger+QB+Abe, (v) BQP-All Machines }
\label{fig:application_architecture}
\end{figure}
