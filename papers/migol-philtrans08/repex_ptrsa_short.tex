...
MPI processes assigned to each replica was varied.  In scenario B, the
\emph{replica number} -- the number of replicas participating in a
generation was varied (cool walking).  We compare the runtime of the
REMD simulation for 64 attempted exchanges on different sets of
