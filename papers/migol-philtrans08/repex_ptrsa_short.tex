...
Fig.~\ref{figure:result_A} shows how the number of active bigjobs
changed during this six hour interval. To start with there were only
enough processors to support one bigjob, but after approximately
two hours, the load on the system changed
