...
(green line in Fig~\ref{figure:result_A}).  REMD simulations (Scenario
...
numbers of active glide-in jobs.  Fig.~\ref{figure:result_A} shows how
...
Fig.~\ref{figure:result_A}).  The average time between exchange
attempts as a function of the number of active glide-ins is shown in
red in Fig.~\ref{figure:result_A}, whereas the speedup (measured as
