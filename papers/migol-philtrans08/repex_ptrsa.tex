...
\begin{figure}[t]
    \centering
      \subfloat[Replica Processes Adaptivity]{\includegraphics[width=0.48\textwidth]{performance/perf_distributed.pdf}}    
      \subfloat[Replica Process Size Adaptivity]{\includegraphics[width=0.48\textwidth]{performance/perf_distributed.pdf}
      } 
       \caption{\footnotesize \bf Performance of the RE-Manager in the
         ...
         \jhanote{It is not clear to me from
           ...
           \alnote{second graph will hopefully be updated soon. However, I need some promising results}
