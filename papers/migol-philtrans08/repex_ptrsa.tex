...
% running REMD across multiple clusters the effects of queue wait
...
\jhanote{Still sensitive to varying load-factors ie queing delays, 
...
\jhanote{we should also note the challenges that arise when physical
  ...
  paper, and how this might possibily be alleviated using distributed
