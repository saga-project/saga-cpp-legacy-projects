...
While SAGA provides a well-defined abstraction to implement the RE framework, there
...
A common principle to prevent queuing delays is the usage of Glide-In jobs  
