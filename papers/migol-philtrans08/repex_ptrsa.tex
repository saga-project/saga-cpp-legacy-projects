...
and (ii) different adaptivity strategies that determines how
...
In principal, the Replica-Agents represents an application-level
...
the Glide-In Manager submits a big Glide-In job, i.\,e.\ the Replica-Agent, 
...
that the underlying physics model is respected.
