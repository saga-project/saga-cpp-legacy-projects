...
been conducted on the LONI Grid~\citep{loni} and TeraGrid
resources.The RE-Manager is used to deploy replia tasks to the
TeraGrid clusters: Ranger, Abe and QueenBee (QB).
