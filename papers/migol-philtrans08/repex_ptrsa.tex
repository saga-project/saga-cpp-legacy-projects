...
\begin{figure}[t]
    ...
    %\includegraphics[width=0.48\textwidth]{performance/perf_distributed_number_replica.pdf}
       \subfloat[Replica Process Size Adaptivity (Scenario A)]{\includegraphics[width=0.48\textwidth]{performance/perf_distributed_size_replica.pdf}}
       \subfloat[Replica Processes Adaptivity (Scenario B)]{\includegraphics[width=0.48\textwidth]{performance/perf_distributed_number_replica.pdf}}    
