...
adaptive allocation of Glide-In jobs, can reduce the time
to solution. Another important issue to reduce the time to solution is a 
mechanism for dynamic  resource discovery and selection. While replicas are 
currently statically assigned to resources, a good selection algorithm can 
avoid crowded resources and thus slowdowns. Various approaches for 
scheduling of resources  e.\,g.\ batch queue 
prediction~\citep{1254939} and advance reservation-based 
schemas~\citep{Jeske:2007wj} have been proposed. However, these approaches 
have been designed for long-running applications. In general, the scheduling 
...
Further, we will refine our RE algorithm toward a more asynchronous solutions, 
as e.\,g.\ described by \citet{Gallicchio:2007yq}, to support a better scaling 
