...
% general setup                     
In scenario A, upto 3 different resources are used, the number of
Glide-Ins vaires from 4 to 12, whilst the number of replicas used is
...
natively, and has been extended~\citep{repex_mpig} to support
...
another MD code for example.  Also, the use of MPIg, or any
...
co-scheduled and where very long or large systems are being simulated
the approach outlined in Ref.~\citep{repex_mpig} is the probably the
preferred approach.
