...
Initially, all Glide-Ins are submitted to the different, 
...
\jhanote{AndreL: Make it easy for the ready to grasp the number of
  ...
  your question: yes} 
Each replica is started with a constant number of 16 MPI processes.  
              
%  
Initially the 4 Glide-Ins are submitted to the different
resources. Similarly to scenario A, different queueing delays
occur on different resources. Using adaptive temperature sampling, the number
of replicas is dynamically increased (upto 16) as the number of
