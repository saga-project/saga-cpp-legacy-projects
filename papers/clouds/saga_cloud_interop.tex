...
\end{tabular}
\upp
\caption{Performance data for different configurations of worker placements. The master places the workers on either Clouds or on the TeraGrid (QueenBee). The configurations -- separated by horizontal lines, are classified as either all workers on the TeraGrid or having all workers on EC2. For the latter, unless otherwise explicitly indicated
