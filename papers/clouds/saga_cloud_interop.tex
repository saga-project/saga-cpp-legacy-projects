...
% \title{pplication-level Interoperability between Clouds and GriTPs}
...
% be addressed in order to avoid problems associated with the complexity
% of Grids.

%the technical and political horror
%stories reminiscent%  of Globus, which became a disastrous by-word for
...
% In general, SAGA has been demonstrated to support a range of
% distributed HPC programming models and applications effectively.
...
% this is an example of using a given resource in the right-way. 
...
% submission to GAM style gatekeeper. In the former the virtual machine
...
recognized by a distributed File-System, such as HDFS. % All file transfer operations are based on the SAGA file
...
%   why? is it interesting to report?}%\subsubsection*{Programming Models for Clouds}
