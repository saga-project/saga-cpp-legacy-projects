...
%  \jhanote{(and autonomically/adaptively): Do we?},
...
and thereby different variants of the RE algorithm. All this is
integrated with the SAGA BigJob(a pilot-job implementation), so that
there is no need to repeatedly wait in queue. We implement and
demonstrate how a flexible and robust implementation enables the
