...
Metropolis scheme~\cite{??}). However, any RE experiment will entail an overhead
...
\jhanote{Should it be $T_{coord}$ or $T_{COORD}$ ? Consistency} \athotanote{it should be $T_{coord}$, fixed}
