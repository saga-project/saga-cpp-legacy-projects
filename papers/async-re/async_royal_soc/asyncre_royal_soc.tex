...
groups of replicas. \jhanote{Andre and I agreed to use 2.2 and not
  1.1. Table and values need to be updated to reflect this} 
...
is in total $0.01\times16=0.2\,s$. Both $T_{ex}$ and $T_{mgmt}$ are same as in the
synchronous case, i.\,e.\ $T_{X}$ is thus: $0.2+0.4+0.2=0.8\,s$.
\jhanote{mention that the number of connexions is smaller to advert
  server hence 0.01 and not 0.1}
...
$T_f$ is approximately $2 \times 64 \times 0.1 = 12.8$ s.
