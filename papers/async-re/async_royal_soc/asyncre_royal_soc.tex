...
pairs. \athotanote{replicas don't wait at the RE Manager. they wait at the bigjob agent..}

\alnote{\textbf{Abhinav: Could you improve the description of this paragraph, please? In particular
I don't really get the last sentence. Is this the worst or average case?} \athotanote{to do..}
...
Thus, $T_W$ is 1.02 s. \alnote{Abhinav: could you please update table 1 with those numbers?} \athotanote{the numbers are already in place}\alnote{no, please double-check. $T_w$ and $T_r$ is 
...
\begin{eqnarray}
T=  {1 \over p} \times {[ {(71\times {128\over 16}}) + (0.78 + 1.02)\times 128]} = {1 \over p} \times 798.4~s
\label{eq:cent}
\end{eqnarray}
