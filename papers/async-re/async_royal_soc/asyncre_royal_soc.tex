...
before it locks a partner to make the exchange. \alnote{Why 15?
...
\alnote{Even if it is random, why should the average \# be different
  ...
  sure. 15 is the average i got after looking at the outputs} Each
query is 0.11 seconds, thus $T_F$ is 1.65 seconds. The process of
...
implementations. \alnote{Is this the reason why the query takes
