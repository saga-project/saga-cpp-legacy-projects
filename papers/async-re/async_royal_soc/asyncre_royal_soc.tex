...
search through $N_R/2$ replicas before it finds a partner. The exchanges are made by the RE Manager and only exchange takes place at a time ($\eta$ is 1). % \alnote{I 
...
\alnote{Abhinav: please cross-check. I am still not sure
whether this: times 32 and then divided by 32 is correct.}
...
case not the average case. The second replica eg has to wait less.} \athotanote{well...}
