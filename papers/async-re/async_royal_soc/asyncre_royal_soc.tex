...
$T_{W}$ is the possible time that some of the replicas might spend in the synchronization step.
...
The different components which make up the total time to completion of an asynchronous RE run would be similar to the traditional RE run, except that there would not be a $T_W$.
