...
replica agent is a wrapper script typically manages an individual
replica and facilitiates the exchange of that replica.
...
In the asynchronous (decentralized) implementation, the RE Manager's
responsibility is greatly reduced and it only needs to keep count of
the number of exchanges completed. When the required number of
