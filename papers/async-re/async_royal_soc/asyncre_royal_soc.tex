...
one exchange takes place at a time ($\eta$ is 1). \alnote{Not sure
  ...
  $\eta_{coord}$ in equation~\ref{eq:totaltime}: one for the MD part
...
leads to some delays at the agent.  In particular, a delay arises %of
