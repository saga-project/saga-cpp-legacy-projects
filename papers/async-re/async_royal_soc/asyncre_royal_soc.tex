...
spent waiting for other replicas. On average, it takes 0.92\,s
to process a replica that has completed running. In an ensemble of 32
replicas the delay between the termination of the first and last
replica adds up to 29.4\,s, i.\,e.\ for one replica pair (there
...
\begin{eqnarray}
  T=  {1 \over p} \times {[ {(71\times {128\over 16}})+ (0.62 + 2.64)\times 128]} = {1 \over p} \times (990) \,s
\label{eq:sync}
\end{eqnarray}
