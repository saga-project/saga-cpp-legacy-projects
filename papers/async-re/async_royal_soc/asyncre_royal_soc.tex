...
A replica can be in one of the these four states: (i) \texttt{running},
...
replica finds that its state has been changed, then it %, i.e., {\it initiating replica}
...
\jhanote{Is this ``it'' the initiating replica or the ``other
  ...
  something is wrong!} \athotanote{modified. any better?} Here the state \texttt{complete} is a marker
