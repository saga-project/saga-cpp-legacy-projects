...
\begin{figure}%
\centering
\subfigure[8 replicas]{\includegraphics[width=0.47\textwidth]{../data/scaleo_8.pdf}}\qquad
\subfigure[16 replicas]{\includegraphics[width=0.47\textwidth]{../data/scaleo_16.pdf}}\\
\subfigure[32 replicas]{\includegraphics[width=0.47\textwidth]{../data/scaleo_32.pdf}}
