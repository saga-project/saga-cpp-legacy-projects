...
\begin{eqnarray}
t=  {1 \over p} \times {[72 + 9.92 + 40]} = {1 \over p} \times 122
\label{eq:timebt}
\end{eqnarray}

The time ($T$) for N$_{X}$ exchanges is therefore $N_{X} \times t = 122 \times 8 = 976 seconds$
