...
%   physically distributed applications.  
  Replica-Exchange (RE) are used to understand physical phenomena --
  ranging from protein folding dynamics to binding affinity
  calculations.  RE methods represent a class of algorithms that
  involve a large number of loosely-coupled ensembles.  We develop a
...
loosely-coupled ensembles.  RE simulations
