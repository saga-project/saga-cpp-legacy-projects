...
starting smaller groups of replicas. \jhanote{Abhinav: Andre and I
  ...
  equation/model and the data dont support each other.}
...
The variation in $T$ with for other values of $N_R$ can, primarily be
...
replicas, as shown in Figure~\ref{fig:scaleup}. The actual difference
observed in $T$ from 32 to 64 replicas is 293 s. % \jhanote{Abhinav
