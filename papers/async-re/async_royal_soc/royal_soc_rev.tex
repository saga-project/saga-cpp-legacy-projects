...
\begin{abstract}{Replica-Exchange, SAGA, Large-Scale, Production}  
  ...
  for RE which supports different replica pairing and coordination
  mechanisms and which can use a range of production cyberinfrastructure
...
new job is found and resources are available, the BigJob-Agent runs the job. If not, the job is queued. It is possible that we might have more sub-jobs than the BigJob can accommodate.
