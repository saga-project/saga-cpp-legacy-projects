...
be:
\begin{eqnarray}
T = {1\over p} \times (T_{MD} \times  {N_X \over \eta}) % {N_R \over 2}}) 
\label{eq:totaltime1}
\end{eqnarray}
...
scheme~\citep{metropolis:1087}, which provides a stochastic algorithm to compare energies. \athotanote{please verify}
...
the RE-Framework is available here ~\citep{async-re_url}.  \jhanote{This needs to be moved
