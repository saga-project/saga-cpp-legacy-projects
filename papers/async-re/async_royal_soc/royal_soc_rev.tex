...
not sure whether I want to open that can of worms again...}
...
implementation where there was a connection to the advert service for
every replica-agent; here there is a single connection. \alnote{previously,
