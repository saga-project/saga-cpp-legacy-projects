...
associated with replica pairing/exchanging ($T_{state}$) (thus $T_{X} =
...
thus $0.1+0.2\times2+0.1\times2=0.7\,s$, so $T_{find} = 0.7\,s$.  Note that
...
server, which is $0.2\,s$+$0.7\,s$ = 0.9\,s.  Thus, $T_{EX}$ is $6.4+0.6 +0.9=
7.2\,s$.  It should be noted that $T_{EX}$ is highly dependent on
