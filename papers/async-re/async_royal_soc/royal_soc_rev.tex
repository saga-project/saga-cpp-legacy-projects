...
always monotonically. Therefore, as $N_R$ increases, the time to
synchronise replicas ($T_W$) typically increases, increasing
$T$. %\jhanote{What is the implication of this?} \athotanote{fixed}
