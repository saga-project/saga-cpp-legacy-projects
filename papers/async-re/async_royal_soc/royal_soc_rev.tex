...
\begin{abstract}{Replica-Exchange, SAGA, Large-Scale, Production}  
  ...
  affinity calculations.  The represent a class of algorithms that
  involve a large number of loosely-coupled ensembles, and are thus
  amenable to utilising distributed resources. We develop a framework
...
supports the use of multiple heterogeneous infrastructure -- as is
typically presented to the end-users.  It is useful to highlight that
