...
the RE algorithm. The physical
system that we use as benchmark is the Hepatitis-C Virus that was
examined in Ref.~\cite{Luckow:2008fp}. The problem and our motivation are similar as before. %\athotanote{check if this ok}\alnote{we could remove it from sec 4. The paragraph can in my opinion be merged with the one above}\athotanote{we already mention the next sentence in section 4.}
