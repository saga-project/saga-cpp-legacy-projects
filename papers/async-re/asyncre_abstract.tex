...
\begin{figure}
\centering
\subfigure[Varying the number of Machines]{
\includegraphics[width=0.40\textwidth]{figures/constant_exchanges.pdf}
\label{fig:subfig1}
}
\subfigure[The configuration used here is of 16 replicas and two 64 core BigJobs - one on QB and one on Louie]{
\includegraphics[width=0.40\textwidth]{figures/graph_async.pdf}
\label{fig:subfig2}
}
