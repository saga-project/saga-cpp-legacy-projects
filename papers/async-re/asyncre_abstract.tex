...
\begin{figure}
\centering
\includegraphics[scale=0.24]{figures/combined_graph.pdf}
\caption{\small The graph shows the completion times of synchronous and asynchronous replica exchange over 1, 2 and 3 machines. The configuration used here is of 16 replicas and four 64 core BigJobs distributed over 1, 2 and 3 machines.}
\label{fig:graph}
\vspace{-1em}
\end{figure}
