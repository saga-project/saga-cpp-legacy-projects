...
\centering
 ...
 \includegraphics[width=0.5\textwidth]{figures/Bigjob_arch.pdf}
...
\includegraphics[width=0.5\textwidth]{figures/synchronous.pdf}
\label{fig:sync}
\vspace{-1em}
}
\label{fig:sync}
...
\section{Scale-Up and Scale-Out Experiments}
