...
\athotanote{do we need a graph showing performance in the best case scenario?}In the best case scenario, where both the BigJobs on 2 different machines start instantaneously upon submission, Cases II and III almost equal their respective performances on a single machine. But Case I underperforms and the reason can be attributed to the heterogeneous infrastructure (QueenBee and Ranger have different processing powers).
