...
From the graph(Figure~\ref{fig:graph}), we see that Case I does not scale up very well when we increase the number of replicas. This is because of the inability to start and end all the replicas at the same time. With more and more replicas, the synchronization cost increases. 
In Case II, the exchanges happen in an asynchronous manner, but they are still conducted by the master alone. As the number of replicas increases, the master quickly becomes a bottleneck. But in Case III, the exchanges are all carried out in a decentralized manner. Many exchanges can occur between different pairs of replicas at the same time. Hence, Case III scales up best.

%
%%%%% FIGURE %%%%%
\begin{figure}
\centering
\includegraphics[scale=0.80]{data/sync.pdf}
\caption{\small The graph shows the mean run times of synchronous RE simulations across one, two and four machines.}
\label{fig:sync}
\vspace{-1em}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[scale=0.80]{data/cent.pdf}
\caption{\small The graph shows the mean run times of asynchronous - centralized RE simulations across one, two and four machines.}
\label{fig:cent}
\vspace{-1em}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[scale=0.80]{data/decent.pdf}
\caption{\small The graph shows the mean run times of asynchronous - decentralized RE simulations across one, two and four machines.}
\label{fig:decent}
\vspace{-1em}
\end{figure}
...
Figure~\ref{fig:sync}, Figure~\ref{fig:cent} and Figure~\ref{fig:decent} show the behavior of Cases I, II and III across one, two and four machines, respectively.

\athotanote{I dont think I will keep the sync, cent and decent graphs(not able to show anything). But I will definitely add graphs for 2 machines and 4 machines. 1M/4BJ, 2M/4BJ, 4M/4BJ is what I am thinking.}
