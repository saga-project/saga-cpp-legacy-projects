...
When going deeper into the reasons for the different performance of the three cases, we need to separate the algorithm from the implementation to accurately understand the performance. Let us first analyze each case and understand the reason for change in time to completion.
