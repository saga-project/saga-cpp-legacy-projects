...
Figure~\ref{fig:allmrs_rands} shows the results. In general, the distributed PMR
...
runtime of both the map and reduce phase. In the random setup, a hierarchical 
...
\caption{Word Count Using Hadoop, Hierarchical Hadoop, Distributed PMR  and 	Hierarchical PMR} 	
