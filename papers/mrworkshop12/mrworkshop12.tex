...
% The execution of the map CUs is done analogous to the chunk CUs via BigJob.
...
and BigData provide an implementation of the Pilot-API. These frameworks ensure
...
phase for each reduce task a DU and CU is generated. These are
