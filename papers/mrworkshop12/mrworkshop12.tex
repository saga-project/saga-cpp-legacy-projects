...
\subsection{BigJob: A Pilot Implementation for Compute}
...
\subsection{BigData: A Pilot Implementation for Data}
...
\jhanote{not described or referenced} provides a distributed communication 
mechanism in a push/pull mode.
