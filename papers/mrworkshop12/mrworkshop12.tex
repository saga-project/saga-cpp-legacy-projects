...
research. The data volumes generated by sequencing machines worldwide is 
...
We measured and plotted each component of the job completion time.

\begin{figure}[compMR]
	\centering
		\includegraphics[width=0.47\textwidth]{figures/HMRvsL-PMRvsD-PMR.png}
	\caption{Pilot MapReduce vs Non-Pilot MapReduce}
	\alnote{What is the chunk size? Distributed vs. non-distributed? which 
	machines?}
