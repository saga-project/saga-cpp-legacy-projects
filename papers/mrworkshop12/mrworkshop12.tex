...
MapReduce configuration that implements the Map-Reduce-Global Reduce pattern on top of distributed resources. For management of the distributed data the implementation relies on GFarm~\cite{Mikami:2011:UGF:2082076.2082106}. 
...
\begin{figure}[htbp]
	...
	\caption{BigData Architecture and Interactions\upp\upp\upp}
...
two machines on FG due to firewall issues) as well as runtime
limitations.
