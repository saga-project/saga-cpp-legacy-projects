...
The runtime of local PMR include time to chunk input data, running the
...
Hadoop MapReduce include time to load input source data into HDFS and
MapReduce runtime.
...
performance of both Hadoop and PMR is comparable upto 8GB. However,
for the largest volumes of input data we examined, PMR shows a better
performance than Hadoop. \jhanote{Can we say why?} Further, the
