...
\begin{abstract}
  ...
  data-intensive applications.  We introduce the Dynamic Application
...
simulations (mostly Molecular Dynamics(MD) ) and virtual-docking simulations, most
...
are devoted to Molecular Biosciences (of which MD is
