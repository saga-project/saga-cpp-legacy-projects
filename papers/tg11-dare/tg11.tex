...
We have shown that the DARE-framework provides the ability to run
multiple MD simulations effectively across multiple resources; this
provides an important motivation for a DARE-based HTHP Science
Gateway. Specifically, we've shown how a SAGA-based DARE-framework
...
Extensible, Adaptive and Simple~\cite{}.
