...
\begin{figure}
 \centering
\includegraphics[scale=0.50]{figures/NAMD1.pdf}

\caption{\small NAMD job submission through DARE-HTHP} 
\end{figure}
\begin{figure}
 \centering
\includegraphics[scale=0.50]{figures/NAMD2.pdf}

\caption{\small NAMD job submission through DARE-HTHP. Multiple Resources, Multiple input files }
  \label{fig:NAMD2}
\end{figure}
...
\subsection{Achieving IDEAS : Interoperability, Distributed
