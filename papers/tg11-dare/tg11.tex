...
% &  &  &  &  &  &  R2,R3) \\ \hline
% B. Glumae   &   32 &          719               &      1067             &  919                   &     712       &    \\
%\hline
%HG18    & 32  &       924                  &            1145            &     1170           &                &       \\
%  (chr21)  &  &  &  &  &  & \\
%\hline
% HG18    & 256  &   9586    &                   &   7582&                &      \\
%
...
DARE-NGS was successfully used in grids and cloud environment. But there were some problems involved like everytime. First the problem was  Futuregird cloud walrus on sierra was unstable like when the data stored on walrus was tried to access by multiple VM's it became unstable. Even if it was stable the amount of data that a bucket is limited to ~30 GB. Where
...
utlized. And even where a single long-running simulation is required,
...
Extensible and Interopable with emerging computational platforms such
as clouds.
...
\smnote{ 1) Lets say we have "n" read files and with DARE it takes
  ...
  across machines.}  Here, we present how the objectives of IDEAS are
