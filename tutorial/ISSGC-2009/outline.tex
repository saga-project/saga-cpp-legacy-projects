...
The summer school infrastructure consists of a set of client machines \texttt{issgc-client-01} to \texttt{issgc-client-20} and a server \texttt{issgc-ui}.

\begin{figure}[!ht]
  \begin{center}
      \includegraphics[width=1\textwidth]{infrastructure}
 \end{center}
  \caption{\small Infrastructure available at ISSGC (SSH based)}
 \label{stuff..}
\end{figure}
