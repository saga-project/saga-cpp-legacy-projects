...
Before you begin, please download the ISSGC09 student-package from our SVN sever.

\begin{verbatim}
svn co https://svn.cct.lsu.edu/repos/saga-projects/tutorial/ISSGC-2009/student-package/
\end{verbatim}

We recommend downloading it in /tmp/ on your machine. 
...
g++ -Wall -I/opt/saga-1.3.1-issgc/include -pthread \ 
    ...
    -lsaga_engine -lsaga_package_file example.cpp
