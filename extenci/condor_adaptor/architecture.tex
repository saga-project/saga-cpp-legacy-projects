...
%    in the context of this work.} 
    ...
    % classification system, we use an informal classification system in
...
% develop system-level tools and applications for each of these types.
    ...
    currently % provides a unified abstraction to Grids, Condor pools
    and % Clouds. Using the same API, applications can dynamically
...
\section {Integration}
    ...
    \begin{itemize} \item \textbf{U.01:} A user submits, monitors and
...
%\jhanote{ I do not know if this belongs here in this document. But I'm
%  putting it here all the same}

%\jhanote{Also I do not know if we should discuss/outline the science
%  problem briefly}
...
\subsubsection{Interface}
    ...
    We have already gained some experience interfacing SAGA with other
...
%  \includegraphics[scale=0.5]{./figures/condor_adaptor_arch} 
