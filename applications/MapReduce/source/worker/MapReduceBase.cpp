 ...
 * but it does the job.                                  *
 * ******************************************************/
int MapReduceBase::hash(std::string input,unsigned int limit) {
   int sum = 0;
   int retval;
 ...
 * ******************************************************/
void MapReduceBase::emitIntermediate(std::string key, std::string value) {
 ...
 * to the proper file.                                   *
 * ******************************************************/
void MapReduceBase::emit(std::string key, std::string value) {
   int mode = saga::filesystem::ReadWrite | saga::filesystem::Create | saga::filesystem::Append;
 ...
 * ******************************************************/
void MapReduceBase::updateStatus_() {
 ...
 * ******************************************************/
std::string MapReduceBase::getFrontendCommand_() {
 ...
 * discovered.                                           *
 * ******************************************************/
void MapReduceBase::mainLoop(unsigned int updateInterval) {
   while(1) {
