...
int main(int argc, char **argv)
{
   ...
   {
      offscl = plane1_to_plane2_transform(0.5, j+0.5, 
	 ...
	 printf("     -> %-g,%-g ->%-g,%-g (%d)\n", lon, lat, oxpixt, oypixt, offscl1);
      ...
      offscl = plane1_to_plane2_transform(input.naxes[0]+0.5, j+0.5,
	                                &oxpixe, &oypixe, &two_plane);
   ...
   {
      offscl = plane1_to_plane2_transform(i+0.5, 0.5, 
                         &oxpixe, &oypixe, &two_plane);
	 ...
	 printf("     -> %-g,%-g ->%-g,%-g (%d)\n", lon, lat, oxpixt, oypixt, offscl1);
      ...
      offscl = plane1_to_plane2_transform(i+0.5, input.naxes[1]+0.5,
	                                &oxpixe, &oypixe, &two_plane);
                   ...
                   double *oypixMin, double *oypixMax)
{
  ...
  offscl = plane2_to_plane1_transform( oxpix, oypix,
                                      &ixpix, &iypix, &two_plane);
