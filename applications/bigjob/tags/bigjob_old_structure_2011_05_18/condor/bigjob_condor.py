...
CONDOR_BIN = "/home/luckow/saga/condor_bin"     # local directory with condor_submit wrapper
...
class bigjob_condor():
    ...
    ################################################################################
    # get_state methods for compatability with standard BigJob
    # HACK! returns state of first pilot
    # Will have to do something more clever
    def get_state_detail(self):
        try:
            return self.glidein_jobs.values()[0].get_state()
        except:
            pass
        return None
