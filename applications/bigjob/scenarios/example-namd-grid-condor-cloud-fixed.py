...
if __name__ == "__main__":
    ...
    total_number_jobs = NUMBER_JOBS_NIMBUS+NUMBER_JOBS_EC2+NUMBER_JOBS_GRID+NUMBER_JOBS_CONDOR
    for i in range(0, NUMBER_JOBS_NIMBUS):
        print "Start job: " +str(number_started_jobs + 1) + " on Nimbus"
    ...
    while True:
        try:
            ...
            print str(number_started_jobs)+"/"+str(total_number_jobs) + " started. EC2: " + str(len(jobs_ec2))\
            ...
            if ((ec2_done+nimbus_done+tg_done+condor_done)==total_number_jobs):
                print "******** Completed Scenario of " + str(total_number_jobs) + " Runtime " + str(time.time()-subjob_start) + " s"
                break
