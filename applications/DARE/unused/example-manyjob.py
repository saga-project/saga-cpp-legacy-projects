...
if __name__ == "__main__":
    try:
        ...
        resource_list = []
        resource_list.append( {"gram_url" : "gram://gatekeeper.ranger.tacc.teragrid.org:2119/jobmanager-sge", "number_cores" : "16", "allocation" : "TG-MCB090174", "queue" : "development", "re_agent": "/share/home/01395/smaddi2/bigjob/bigjob_agent_launcher.sh"})
        ...
        for i in range(0, NUMBER_JOBS):
            ...
            jd.arguments = [""]
            jd.working_directory = "/work/01395/smaddi2/output"
            jd.output =  "/work/01395/smaddi2/output/stdout-" + str(i) + ".txt"
            jd.error = "/work/01395/smaddi2/output/stderr-" + str(i) + ".txt"
