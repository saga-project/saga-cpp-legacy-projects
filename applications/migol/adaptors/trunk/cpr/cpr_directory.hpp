...
#ifndef ADAPTORS_MIGOL_CPR_DIRECTORY_HPP
#define ADAPTORS_MIGOL_CPR_DIRECTORY_HPP
...
namespace cpr
{
    ...
    private:
        ...
        saga::replica::logical_directory * ld_;
...
//      void sync_read_link       (saga::url & tgt, saga::url name);
        ...
        void sync_get_num_entries (unsigned int & num);
        void sync_get_entry       (saga::url    & url, unsigned int idx);
