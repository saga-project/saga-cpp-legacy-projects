...
echo "# WU  #Avg #Stddev" > ${DATA_DIR_PROCESSED}/data_file_redis
echo "# WU  #Avg #Stddev" > ${DATA_DIR_PROCESSED}/data_file_redis_local
echo "# WU  #Avg #Stddev" > ${DATA_DIR_PROCESSED}/data_file_advert
echo "# WU  #Avg #Stddev" > ${DATA_DIR_PROCESSED}/data_file_zmq
...
echo "# WU  #Avg #Stddev" > ${DATA_DIR_PROCESSED}/data_file_cores_redis
echo "# WU  #Avg #Stddev" > ${DATA_DIR_PROCESSED}/data_file_cores_redis_local
echo "# WU  #Avg #Stddev" > ${DATA_DIR_PROCESSED}/data_file_cores_advert
echo "# WU  #Avg #Stddev" > ${DATA_DIR_PROCESSED}/data_file_cores_zmq

for i in 1 2 4 8 16; do
	averages=`cat results/* | grep advert:// | grep ${i},8 | awk -F, '{print $4-$5}' | awk -f analyze.awk`	
done