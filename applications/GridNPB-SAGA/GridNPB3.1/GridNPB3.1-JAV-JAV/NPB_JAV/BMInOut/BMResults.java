...
public class BMResults implements Serializable{
  ...
  public void print(){    
    ...
    if(out!=null){
      try{
 	outline="***** NAS Parallel Benchmarks Java version (NPB3.0-JAV) "
	              +name+" Report *****";
  ...
  public static void printVerificationStatus(char clss,int verified,
                                             String BMName){
