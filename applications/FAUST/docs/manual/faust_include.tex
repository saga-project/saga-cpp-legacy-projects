...
\newcommand{\ppcorelibs}{
  \textit{pp Core Libraries}
}

\newcommand{\ppdefaultadaptors}{
...
\newcommand{\ppdate}{\today}

\newcommand{\ppheader}{}
  \lhead{\ppdocument}
  \chead{\ppheader}
  \rhead{\ppdate}
  \lfoot{\hrulefill\\\T{\ppemail} \hfill \thepage}
  \cfoot{}
  \rfoot{}
...
\newcommand{\ppnsec}[2]
{
  \section{#1}
  \label{sec:#2}
  \renewcommand{\ppheader}{#1}
  \iffinal
    \input{\ppbasename_#2.tex.final}
  \else
    \input{\ppbasename_#2.tex}
  \fi
}
...
\newcommand{\ppbib}[1]{
  \renewcommand{\ppheader}{References}
