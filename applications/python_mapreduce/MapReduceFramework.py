...
class MapReduce:
    ...
    def conf_check(self):
        ...
        par_conf={"advert":0, "bigjob":0, "chunk_size":0, "input":0,"temp":0, "output":0,"temp_url":0, "map_script":0,"reduce_script":0,"nbr_reduces":0,"partition_script":0}
            ...
            if os.path.isfile(config_file):
                ...
                for par,value in conf.iteritems():
                    ...
                    if par == "bigjob":
                        ...
                        self.__resource_list.append( {"gram_url" : self.__url, "number_cores" : "8", "allocation" : "loni_stopgap10", 
                           "queue" : "workq", "re_agent": self.__re_agent, "working_directory":"/work/pmantha/output/", "walltime":10 })
                        self.__reduce_resource_list.append( {"gram_url" : self.__output_url, "number_cores" : "8", "allocation" : "loni_stopgap10", 
                           "queue" : "workq", "re_agent": self.__re_agent, "working_directory":"/work/pmantha/output/", "walltime":10 }) 
